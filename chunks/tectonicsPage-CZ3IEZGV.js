...
Scales shield volcano heights and magmatic rift fill.`,"Climate Erosion":v({overview:"Erosion rate adjusted for climate and atmospheric moisture.",drawnFrom:"Surface temperature, atmospheric H2O, pressure/water context, and the active planet climate solve.",feedsInto:"Inactive mountain range decay and tectonic-factor summaries.",interpretAs:"Warmer and wetter worlds erode faster than cold, dry worlds.",caveat:"This is a broad climate modifier, not a detailed hydrology or sediment model.",references:"See Science & Maths: climate erosion."}),"Elastic Lithosphere":v({overview:"Thickness of the elastic lithosphere in km.",drawnFrom:"Planet age, mass/gravity, internal heat, radiogenic context, and tidal heating.",feedsInto:"Shield volcano flexural support, rift geometry, and tectonic-factor summaries.",interpretAs:"Thicker lithosphere supports taller volcanic edifices; tidal heating and high internal heat thin it.",caveat:"This is an effective elastic thickness, not a full lithosphere thermal model.",references:"See Science & Maths: lithosphere and solid-body response."}),"Arc Distance":`Distance from the oceanic trench to the volcanic arc (km). Computed as slab depth / tan(slab angle).
                  ...
                  ${e.mountainRanges.map((x,f)=>`
                    <div class="tec-range-card ${f===b?"is-selected":""}" data-idx="${f}">
                      <div class="tec-range-card__header">
                        <select class="tec-type-select" data-idx="${f}">
                ...
                <div id="tecInactiveCards">
                  ${e.inactiveRanges.map((x,f)=>`
                    <div class="tec-range-card">
                      <div class="tec-range-card__header">
                        <select class="tec-inactive-type" data-idx="${f}">
                          ${ue.map(I=>`<option value="${I.key}" ${x.type===I.key?"selected":""}>${T(I.label)}</option>`).join("")}
                        </select>
