import{a as n,b as e,c as d,d as a,e as p,f as s,g as l,h as o,i as x,j as T,k as f}from"./chunk-B66B57MG.js";import{Q as y,R as w,T as v}from"./chunk-GLBR67F3.js";import"./chunk-Q3EXAOWE.js";import"./chunk-ASLSWSPR.js";import"./chunk-VW67QI3I.js";import{C as c}from"./chunk-TXBNWBBK.js";import"./chunk-6DA3R6ZF.js";import"./chunk-RC2KHOII.js";import"./chunk-WLUJ3GDC.js";function k(t){return[s("What Is the Habitable Zone?",`<p>The <strong>habitable zone</strong> (HZ) is the range of distances
      ...
      ${f("les05-outer","HZ outer edge (AU)")}`)].join("")}function Z(t){let r=t.querySelector("#les05-mass"),i=t.querySelector("#les05-massSlider"),m=t.querySelector("#les05-inner"),b=t.querySelector("#les05-outer");if(!r||!i||!m||!b)return;function h(){let u=parseFloat(r.value)||1;i.value=u;let $=v(u),S=y(u),g=w({luminosityLsol:$,teffK:S});m.textContent=c(g.innerAu,4),b.textContent=c(g.outerAu,4)}r.addEventListener("input",h),i.addEventListener("input",()=>{r.value=i.value,h()}),h()}export{k as buildLesson05,Z as wireLesson05};
