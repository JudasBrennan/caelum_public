import{a,b as e,c as h,d as s,e as w,f as r,g as p,h as o,i as M,j as v,k as d}from"./chunk-B66B57MG.js";import{Q as y,T as b}from"./chunk-GLBR67F3.js";import"./chunk-Q3EXAOWE.js";import"./chunk-ASLSWSPR.js";import"./chunk-VW67QI3I.js";import{C as u}from"./chunk-TXBNWBBK.js";import"./chunk-6DA3R6ZF.js";import"./chunk-RC2KHOII.js";import"./chunk-WLUJ3GDC.js";function _(t){return[r("What Makes a Star",`<p>A star is a massive ball of hot gas \u2014 mostly hydrogen \u2014 held together
      ...
      ${d("les01-life","Main-sequence lifetime (Gyr)")}`)].join("")}function A(t){let n=t.querySelector("#les01-mass"),i=t.querySelector("#les01-massSlider"),c=t.querySelector("#les01-lum"),g=t.querySelector("#les01-teff"),f=t.querySelector("#les01-life");if(!n||!i||!c||!g||!f)return;function m(){let l=parseFloat(n.value)||1;i.value=l;let $=b(l),x=y(l),L=10/Math.pow(l,2.5);c.textContent=u($,4),g.textContent=u(x,0),f.textContent=u(L,4)}n.addEventListener("input",m),i.addEventListener("input",()=>{n.value=i.value,m()}),m()}export{_ as buildLesson01,A as wireLesson01};
