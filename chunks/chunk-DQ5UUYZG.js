import{a as t}from"./chunk-4DOSHAKO.js";function e(a,r,s){return`
    <div class="page-intro__item" data-page-intro-key="${t(a)}">
      <dt class="page-intro__label">${t(r)}</dt>
      <dd class="page-intro__value">${t(s)}</dd>
    </div>
  `}function g({summary:a="",controls:r="",affects:s="",primaryAction:n="",compact:o=!1,detailsTitle:l="Details",detailsSummary:p=""}={}){let i=`
