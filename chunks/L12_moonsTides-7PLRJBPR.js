import{a as s,b as t,c as i,d as n,e as p,f as o,g as c,h as a,i as R,j as h,k as I}from"./chunk-L3XYPVN7.js";import{j as S}from"./chunk-T2JC7ILW.js";import"./chunk-VC46IEJQ.js";function j(e){return[o("The Roche Limit",`<p>Every planet has an invisible danger zone close to its surface. If a
      ...
      ${s("d_\\text{Roche} = 2.44\\;R_p\\;\\left(\\frac{\\rho_p}{\\rho_m}\\right)^{1/3}")}
      ...
      ${n("Roche (1849); Murray & Dermott (1999), Solar System Dynamics, Ch. 4")}`,e),o("The Hill Sphere",`<p>Just as there is a minimum distance (the Roche limit), there is also
      ...
      ${s("r_\\text{Hill} = a\\;\\left(\\frac{M_p}{3\\,M_\\star}\\right)^{1/3}")}
      ...
      ${n("Hamilton & Burns (1991, Icarus 92, 118); Murray & Dermott (1999), Solar System Dynamics, Ch. 9")}`,e),o("Tidal Locking",`<p>Our Moon always shows the same face to Earth. This is not a
      ...
      ${a("Tidal forces slow a moon's rotation over time until one face permanently points toward the planet. This is why we only ever see one side of our Moon.")}`,`<p>The timescale for a satellite to tidally lock (despinning from an
        ...
        approximately:</p>
      ${s("t_\\text{lock} \\approx \\frac{\\omega_0\\;a^6\\;I\\;Q}{3\\,G\\,M_p^2\\,k_2\\,R_m^5}")}
      ...
      ${n("Gladman et al. (1996, Icarus 122, 166); Peale (1999, ARA&A 37, 533)")}`,e),o("Tidal Heating",`<p>When a moon's orbit is not perfectly circular, its distance to the
      ...
      ${s("\\dot{E} = \\frac{21}{2}\\;\\frac{k_2}{Q}\\;\\frac{G\\,M_p^2\\,R_m^5\\,n\\,e^2}{a^6}")}
      ...
      ${n("Peale, Cassen & Reynolds (1979, Science 203, 892); Segatz et al. (1988, Icarus 75, 187)")}`,e),o("Orbital Fate",`<p>Tidal forces do not just heat moons \u2014 they also change their orbits
      ...
      ${s("\\frac{da}{dt} = \\text{sgn}(\\Omega_p - n)\\;\\frac{3\\,k_{2p}}{Q_p}\\;\\frac{M_m}{M_p}\\;\\frac{R_p^5}{a^4}\\;n")}
      ...
      ${n("Goldreich & Soter (1966, Icarus 5, 375); Bills et al. (2005, J. Geophys. Res. 110, E07004)")}`,e),o("Moon Worlds in WorldSmith",`<p>WorldSmith now treats moons as small worlds rather than only tidal case studies. The Moon page derives a first-pass atmosphere, hydrosphere, climate, geology, biosphere, radiation, and habitability output from the same saved moon inputs used elsewhere in the app.</p>
      ...
      ${I("les12-heat","Tidal heating (TW): ")}`)].join("")}function C(e){let m=e.querySelector("#les12-mass"),b=e.querySelector("#les12-massSlider"),y=e.querySelector("#les12-moonR"),v=e.querySelector("#les12-moonRSlider"),w=e.querySelector("#les12-dist"),k=e.querySelector("#les12-distSlider"),x=e.querySelector("#les12-ecc"),M=e.querySelector("#les12-eccSlider"),_=e.querySelector("#les12-heat");if(!m||!_)return;function u(){let r=parseFloat(m.value)||318,l=parseFloat(y.value)||1822,T=parseFloat(w.value)||422e3,g=parseFloat(x.value)||.004;b.value=r,v.value=l,k.value=T,M.value=g;let $=6674e-14,f=r*5972e21,H=l*1e3,d=T*1e3,E=Math.sqrt($*f/(d*d*d)),F=21/2*(.03/100)*$*f*f*Math.pow(H,5)*E*g*g/Math.pow(d,6)/1e12;_.textContent=S(F,4)}let q=[[m,b],[y,v],[w,k],[x,M]];for(let[r,l]of q)r.addEventListener("input",u),l.addEventListener("input",()=>{r.value=l.value,u()});u()}export{j as buildLesson12,C as wireLesson12};
