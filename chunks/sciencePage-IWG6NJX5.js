import{a as he,b as fe,c as ee}from"./chunk-ZHMAGPLP.js";import{b as pe,d as ue,e as me}from"./chunk-KD5CBWLO.js";import{a as de}from"./chunk-D6EOQ2LP.js";import"./chunk-2TUOATMO.js";import{d as ce}from"./chunk-I2FVXFMW.js";import{d as le}from"./chunk-3MZTWI7A.js";import{a as I}from"./chunk-WYZYYRUA.js";import{b as J,c as Y}from"./chunk-XMLMEZIZ.js";import{a as L,b as z}from"./chunk-WNGVR2CK.js";import{K as X,N as oe,O as ne}from"./chunk-PEDZU4MZ.js";import{j as m}from"./chunk-T2JC7ILW.js";import"./chunk-VC46IEJQ.js";function j(i,r){return i&&(i.textContent=r==null?"":String(r),i)}function be(i,{countLabel:r="32",countValue:n="",alphaValue:p=""}={}){return i&&(Y(i,["N",J("sub",{text:r}),` = ${n} \u2014 \u03B1 = ${p}`]),i)}function U(i,r=[],n=""){if(!i)return i;let p=(r||[]).filter(Boolean);if(!p.length)return i.textContent=n==null?"":String(n),i;let l=[];return p.forEach((u,f)=>{f>0&&l.push(J("br")),l.push(J("strong",{text:u?.fraction||""}),` \u2014 ${u?.description||""}`)}),Y(i,l),i}function t(i){return`<span class="sci-math sci-math--block">${i}</span>`}function e(i){return`<span class="sci-math">${i}</span>`}function o(i){return`<table class="sci-vars"><tbody>${i.map(([r,n])=>`<tr><td>${e(r)}</td><td>${n}</td></tr>`).join("")}</tbody></table>`}function s(i){return`<p class="sci-cite">${i}</p>`}function a(i,r){return`<div class="sci-formula"><h3 class="sci-formula__name">${i}</h3>${r}</div>`}var xe=Object.freeze({stellar:[{label:"Star",href:"#/star"}],evolution:[{label:"Star",href:"#/star"}],activity:[{label:"Star",href:"#/star"}],planetary:[{label:"Planet",href:"#/planet"},{label:"Climate",href:"#/climate"}],interior:[{label:"Planet",href:"#/planet"}],tectonics:[{label:"Planet",href:"#/planet"},{label:"Tectonics",href:"#/tectonics"}],atmosphere:[{label:"Planet",href:"#/planet"},{label:"Climate",href:"#/climate"}],climate:[{label:"Climate",href:"#/climate"},{label:"Planet",href:"#/planet"}],gasgiant:[{label:"Planet",href:"#/planet"},{label:"Moon",href:"#/moon"}],orbital:[{label:"Moon",href:"#/moon"},{label:"System",href:"#/system"}],calendar:[{label:"Calendar",href:"#/calendar"}],system:[{label:"System",href:"#/system"},{label:"Star",href:"#/star"}],divergences:[{label:"Validation",href:"#/validation"}]});function $e(i){let r=xe[i]||[];return r.length?`<nav class="sci-related-pages" aria-label="Related app pages">
    ...
    <div class="sci-phase-legend" aria-label="Diagram legend">
      ...
      ${s("Hurley, Pols &amp; Tout (2000), MNRAS 315, 543")}`)].join("")}function Ee(){return[a("Mass&ndash;Radius Relation (Radius-First)",`<div class="sci-formula__eq">${t("R_\\oplus = (1.07 - 0.21 \\cdot \\text{CMF}) \\cdot M_\\oplus^{\\,\\alpha}")}</div>
      ...
      ${d(["Rotation period","Cells"],[["&ge; 48 h","1 (single Hadley)"],["6 &ndash; 48 h","3 (Earth-like)"],["3 &ndash; 6 h","7 (rapid rotator)"],["&lt; 3 h","5 (very rapid)"]])}`)].join("")}function He(){return[a("Mass&ndash;Radius Relation",`<p>Two-regime power law calibrated to Solar System giants:</p>
      ...
      <p>If ${e("\\theta_{\\text{moon}} \\ge \\theta_\\star")}: total eclipses. Otherwise: annular only.</p>`)].join("")}function Oe(){return[a("Scale Height Correction",`<div class="sci-formula__eq">${t("\\frac{H_{\\text{planet}}}{H_\\oplus} = \\frac{T / T_\\oplus}{g / g_\\oplus}")}</div>
      ...
      <p>Day-of-week index for year ${e("y")}, where ${e("L_i")} is the length of year ${e("i")} and ${e("D_w")} is days per week. Computed in O(rules) time by counting leap rule firings.</p>`)].join("")}function Ne(){return[a("Neighbourhood Volume",`<div class="sci-formula__eq">${t("V = \\frac{4}{3}\\pi R^3")}</div>
    ...
    to Caelum; items marked <b>Simplified</b> are reductions of published work.</p>`,i("Oort Cloud Mass And LPC Flux Proxy (WS-derived / Simplified)",`<p>Caelum&rsquo;s Oort-cloud mass and long-period-comet flux are not taken from a single published closed-form model. The edge scaling follows exo-Oort Hill-radius work, but the mass and LPC-rate outputs are Caelum proxies built from five factors: total giant mass, outer-giant extent, inner-ejector depletion, age saturation, and environmental retention.</p>
      ...
      ${s("Mardling &amp; Aarseth (2001), MNRAS 321, 398; Caelum hierarchy guardrails in engine/homeSystem/stability.js")}`)].join("")}function Ue(i,r){let n=r/100,p=Math.log(Math.max(i,1e-6)),l=Math.min(1/3,.257-.0161*p),u=(1.07-.21*n)*Math.pow(i,l),f=i*5.51/Math.pow(u,3);return{R:u,rho:f}}function Ze(i){let r=i.querySelector("#sci-mlr-mass"),n=i.querySelector("#sci-mlr-slider"),p=i.querySelector("#sci-mlr-result");if(r&&n&&p){let _=()=>{let h=X(Number(r.value));p.textContent=`${m(h,4)} L\u2609`};I({numberEl:r,sliderEl:n,min:.075,max:100,step:.01,mode:"log"}),r.addEventListener("input",_),n.addEventListener("input",()=>{r.dispatchEvent(new Event("input"))}),_()}let l=i.querySelector("#sci-hz-mass"),u=i.querySelector("#sci-hz-slider"),f=i.querySelector("#sci-hz-result");if(l&&u&&f){let _=()=>{let h=Number(l.value),w=X(h),T=oe(h),D=ne({luminosityLsol:w,teffK:T});j(f,`${m(D.innerAu,2)} \u2013 ${m(D.outerAu,2)} AU`)};I({numberEl:l,sliderEl:u,min:.075,max:100,step:.01,mode:"log"}),l.addEventListener("input",_),u.addEventListener("input",()=>{l.dispatchEvent(new Event("input"))}),_()}let v=i.querySelector("#sci-dens-mass"),q=i.querySelector("#sci-dens-mass-slider"),M=i.querySelector("#sci-dens-cmf"),P=i.querySelector("#sci-dens-cmf-slider"),R=i.querySelector("#sci-dens-result");if(v&&q&&M&&P&&R){let _=()=>{let{R:h,rho:w}=Ue(Number(v.value),Number(M.value));j(R,`${m(h,3)} R\u2295 \u2014 ${m(w,2)} g/cm\xB3`)};I({numberEl:v,sliderEl:q,min:.01,max:100,step:.01,mode:"log"}),I({numberEl:M,sliderEl:P,min:0,max:100,step:1,mode:"linear"}),[v,q,M,P].forEach(h=>h.addEventListener("input",_)),_()}let C=i.querySelector("#sci-hmag-rad"),F=i.querySelector("#sci-hmag-alb"),A=i.querySelector("#sci-hmag-alb-slider"),G=i.querySelector("#sci-hmag-result");if(C&&F&&G){let _=()=>{let h=Number(C.value),w=Number(F.value);if(h>0&&w>0){let T=ce({radiusKm:h,geometricAlbedo:w});G.textContent=`H = ${m(T,2)}`}};A&&I({numberEl:F,sliderEl:A,min:.01,max:1,step:.01,mode:"linear"}),[C,F].forEach(h=>h.addEventListener("input",_)),A&&A.addEventListener("input",_),_()}let E=i.querySelector("#sci-flare-temp"),O=i.querySelector("#sci-flare-temp-slider"),W=i.querySelector("#sci-flare-age"),c=i.querySelector("#sci-flare-age-slider"),b=i.querySelector("#sci-flare-result");if(E&&W&&b){let _=()=>{let h=le({teffK:Number(E.value),ageGyr:Number(W.value)});be(b,{countLabel:"32",countValue:h.N32,alphaValue:h.alpha})};O&&I({numberEl:E,sliderEl:O,min:2e3,max:1e4,step:100,mode:"linear"}),c&&I({numberEl:W,sliderEl:c,min:.01,max:13,step:.1,mode:"linear"}),[E,O,W,c].filter(Boolean).forEach(h=>h.addEventListener("input",_)),_()}let x=i.querySelector("#sci-leap-len"),$=i.querySelector("#sci-leap-result");if(x&&$){let _=w=>{if(w===0)return{p:0,q:1};let T=0,D=1;for(let H=1;H<=1e4;H++){let S=Math.round(w*H);if(Math.abs(S/H-w)<1e-9){T=S,D=H;break}}return{p:T,q:D}},h=()=>{let w=Number(x.value),T=w-Math.floor(w);if(T<1e-9){U($,[],"No leap cycle needed (integer year)");return}let H=de(T,6).slice(1).map(_).filter(S=>S.q>0);if(H.length===0){U($,[],"No usable cycle found");return}U($,H.map(S=>{let se=Math.abs(S.p/S.q-T),re=se>1e-12?Math.round(1/se):1/0,_e=re===1/0?"exact":`~1 day drift per ${m(re,0)} yr`;return{fraction:`${S.p}/${S.q}`,description:`${S.p} leap day${S.p!==1?"s":""} every ${S.q} years (${_e})`}}))};x.addEventListener("input",h),h()}let k=i.querySelector("#sci-ghz-r"),g=i.querySelector("#sci-ghz-loc"),y=i.querySelector("#sci-ghz-result");if(k&&g&&y){let _=()=>{let h=Number(k.value),w=Number(g.value),T=.53*h,D=.1*h,H=Math.exp(-.5*Math.pow((w-T)/D,2)),S=w>=.47*h&&w<=.6*h;j(y,`${m(H*100,1)}%${S?" (in hard band)":""}`)};[k,g].forEach(h=>h.addEventListener("input",_)),_()}let B=i.querySelector("#sci-tec-grav"),Q=i.querySelector("#sci-tec-grav-slider"),te=i.querySelector("#sci-tec-mtn"),ae=i.querySelector("#sci-tec-shield"),ie=i.querySelector("#sci-tec-root");if(B&&Q&&te&&ae&&ie){let _=()=>{let h=Number(B.value);h>0&&(te.textContent=`${m(pe(h),0)} m`,ae.textContent=`${m(me(h),0)} m`,ie.textContent=`${m(ue(5e3),0)} m`)};I({numberEl:B,sliderEl:Q,min:.05,max:5,step:.01,mode:"log"}),B.addEventListener("input",_),Q.addEventListener("input",()=>{B.dispatchEvent(new Event("input"))}),_()}}var ye=[{id:"stellar",title:"Stellar Physics",count:9,builder:Re},{id:"evolution",title:"Stellar Evolution",count:7,builder:Ae},{id:"planetary",title:"Planetary Physics",count:14,builder:Ee},{id:"gasgiant",title:"Gas Giant Physics",count:13,builder:He},{id:"interior",title:"Interior &amp; Composition",count:7,builder:Be},{id:"tectonics",title:"Tectonics &amp; Geodynamics",count:14,builder:Ve},{id:"orbital",title:"Orbital Mechanics",count:22,builder:Le},{id:"lagrange",title:"Lagrange Points",count:4,builder:Fe},{id:"photometry",title:"Photometry &amp; Magnitudes",count:8,builder:Ge},{id:"atmosphere",title:"Atmosphere &amp; Colour",count:10,builder:Oe},{id:"climate",title:"Climate Classification",count:8,builder:Ie},{id:"activity",title:"Stellar Activity",count:7,builder:De},{id:"calendar",title:"Calendar Systems",count:5,builder:We},{id:"cluster",title:"Local Cluster",count:7,builder:Ne},{id:"population",title:"Population Dynamics",count:5,builder:Ke},{id:"system",title:"System Architecture",count:7,builder:je},{id:"debris",title:"Debris Disks",count:12,builder:ze},{id:"divergences",title:"Divergences from Published Science",count:36,builder:Je}];function dt(i){let r=document.createElement("div");r.className="page";let n=ye.map(c=>`<a class="sci-toc__link" data-target="sci-${c.id}" href="#sci-${c.id}">${c.title}</a>`).join(""),p=ye.map((c,b)=>`<details class="sci-section" id="sci-${c.id}"${b===0?" open":""}>
  ...
  `,i.innerHTML="",i.appendChild(r);let l=Array.from(r.querySelectorAll(".sci-section")),u=Array.from(r.querySelectorAll(".sci-formula")),f=Array.from(r.querySelectorAll(".sci-toc__link")),v=r.querySelector("#sciencePageSearch"),q=r.querySelector("#sciencePageSearchStatus"),M=r.querySelector("#sciencePageSearchResults"),P=Pe(r),R=null,C=!1,F=l.find(c=>c.open)?.id||l[0]?.id||null,A=(c,{exclusive:b=!C}={})=>{c&&(b?l.forEach(x=>{x.open=x===c}):c.open=!0,!C&&c.id&&(F=c.id))},G=()=>{R&&(clearTimeout(R),R=null),r.querySelectorAll(".sci-formula.is-search-hit").forEach(c=>{c.classList.remove("is-search-hit")})},E=c=>{if(!c)return;let b=r.querySelector(`#${c}`);if(!b)return;let x=b.closest(".sci-section");A(x),G(),b.classList.add("is-search-hit"),ee(b,{block:"center"}),b.focus?.({preventScroll:!0}),R=window.setTimeout(()=>{b.classList.remove("is-search-hit"),R=null},2200)},O=c=>{let b=N(c);if(G(),!b){C=!1,r.classList.remove("is-search-filtering"),u.forEach(y=>{y.hidden=!1,y.classList.remove("is-search-match","is-search-filtered-out")}),l.forEach(y=>{y.hidden=!1,y.classList.remove("is-search-match","is-search-filtered-out")}),f.forEach(y=>{y.hidden=!1,y.classList.remove("is-search-filtered-out")});let g=l.find(y=>y.id===F)||l[0]||null;return A(g,{exclusive:!0}),[]}let x=ge(P,b,P.length),$=new Set(x.map(g=>g.id)),k=new Set(x.map(g=>g.sectionId));return C=!0,r.classList.add("is-search-filtering"),u.forEach(g=>{let y=$.has(g.id);g.hidden=!y,g.classList.toggle("is-search-match",y),g.classList.toggle("is-search-filtered-out",!y)}),l.forEach(g=>{let y=k.has(g.id);g.hidden=!y,g.open=y,g.classList.toggle("is-search-match",y),g.classList.toggle("is-search-filtered-out",!y)}),f.forEach(g=>{let y=k.has(g.dataset.target||"");g.hidden=!y,g.classList.toggle("is-search-filtered-out",!y)}),x},W=(c,b=null)=>{if(!M||!q)return[];let x=N(c);if(!x)return M.hidden=!0,M.innerHTML="",q.hidden=!0,q.textContent="",[];let $=b||ge(P,x,P.length),k=$.slice(0,8);return q.hidden=!1,q.textContent=$.length>0?`${$.length} match${$.length===1?"":"es"}${$.length>k.length?`, showing top ${k.length}`:""}`:"No matches found",$.length===0?(M.hidden=!1,M.innerHTML='<div class="sci-search__empty">No formulas or topics matched that search.</div>',[]):(M.hidden=!1,M.innerHTML=k.map(g=>`
          ...
          </button>`).join(""),k)};l.forEach(c=>{c.addEventListener("toggle",()=>{if(c.open){if(!C&&c.id&&(F=c.id),C)return;l.forEach(b=>{b!==c&&(b.open=!1)})}})}),f.forEach(c=>{c.addEventListener("click",b=>{b.preventDefault();let x=c.dataset.target,$=r.querySelector(`#${x}`);$&&(A($),ee($,{block:"start"}))})}),v?.addEventListener("input",()=>{let c=O(v.value);W(v.value,c)}),v?.addEventListener("keydown",c=>{if(c.key!=="Enter")return;let b=O(v.value),[x]=W(v.value,b);x&&(c.preventDefault(),E(x.id))}),M?.addEventListener("click",c=>{let b=c.target.closest(".sci-search__result");b&&E(b.getAttribute("data-target-id"))}),Ze(r),he().then(c=>fe(r,c))}export{dt as initSciencePage};
