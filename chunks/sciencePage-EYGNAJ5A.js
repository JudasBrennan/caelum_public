import{a as he,b as fe,c as ee}from"./chunk-RQD3Y6ZB.js";import{a as de}from"./chunk-D6EOQ2LP.js";import{b as pe,d as ue,e as me}from"./chunk-KD5CBWLO.js";import{d as ce}from"./chunk-VPI7BJPM.js";import{a as I}from"./chunk-WYZYYRUA.js";import"./chunk-72D267T6.js";import{d as le}from"./chunk-3MZTWI7A.js";import{b as J,c as Y}from"./chunk-XMLMEZIZ.js";import{a as L,b as z}from"./chunk-WNGVR2CK.js";import{L as X,O as oe,P as ne}from"./chunk-TIXSLYXP.js";import{j as m}from"./chunk-T2JC7ILW.js";import"./chunk-VC46IEJQ.js";function j(i,r){return i&&(i.textContent=r==null?"":String(r),i)}function be(i,{countLabel:r="32",countValue:n="",alphaValue:p=""}={}){return i&&(Y(i,["N",J("sub",{text:r}),` = ${n} \u2014 \u03B1 = ${p}`]),i)}function U(i,r=[],n=""){if(!i)return i;let p=(r||[]).filter(Boolean);if(!p.length)return i.textContent=n==null?"":String(n),i;let l=[];return p.forEach((u,f)=>{f>0&&l.push(J("br")),l.push(J("strong",{text:u?.fraction||""}),` \u2014 ${u?.description||""}`)}),Y(i,l),i}function t(i){return`<span class="sci-math sci-math--block">${i}</span>`}function e(i){return`<span class="sci-math">${i}</span>`}function o(i){return`<table class="sci-vars"><tbody>${i.map(([r,n])=>`<tr><td>${e(r)}</td><td>${n}</td></tr>`).join("")}</tbody></table>`}function s(i){return`<p class="sci-cite">${i}</p>`}function a(i,r){return`<div class="sci-formula"><h3 class="sci-formula__name">${i}</h3>${r}</div>`}var xe=Object.freeze({stellar:[{label:"Star",href:"#/star"}],evolution:[{label:"Star",href:"#/star"}],activity:[{label:"Star",href:"#/star"}],planetary:[{label:"Planet",href:"#/planet"},{label:"Climate",href:"#/climate"}],interior:[{label:"Planet",href:"#/planet"}],tectonics:[{label:"Planet",href:"#/planet"},{label:"Tectonics",href:"#/tectonics"}],atmosphere:[{label:"Planet",href:"#/planet"},{label:"Climate",href:"#/climate"}],climate:[{label:"Climate",href:"#/climate"},{label:"Planet",href:"#/planet"}],gasgiant:[{label:"Planet",href:"#/planet"},{label:"Moon",href:"#/moon"}],orbital:[{label:"Moon",href:"#/moon"},{label:"System",href:"#/system"}],calendar:[{label:"Calendar",href:"#/calendar"}],system:[{label:"System",href:"#/system"},{label:"Star",href:"#/star"}],divergences:[{label:"Validation",href:"#/validation"}]});function $e(i){let r=xe[i]||[];return r.length?`<nav class="sci-related-pages" aria-label="Related app pages">
    ...
    <div class="sci-phase-legend" aria-label="Diagram legend">
      ...
      ${s("Hurley, Pols &amp; Tout (2000), MNRAS 315, 543")}`),a("Analytic Stellar Lifecycle Track",`<div class="sci-formula__eq">${t("S(t) = \\{\\text{MS},\\,\\text{TMS},\\,\\text{subgiant},\\,\\text{giant},\\,\\text{He burning},\\,\\text{AGB/supergiant},\\,\\text{remnant}\\}")}</div>
      <div class="sci-formula__eq">${t("t_i = t_{\\text{MS}} + f_i(M)\\,t_{\\text{MS}}")}</div>
      <div class="sci-formula__eq">${t("M_{\\text{rem}} \\approx \\begin{cases}0.109M+0.394 & M < 7.8 \\\\ 1.3\\text{--}2.1 & 10 \\le M < 25 \\\\ \\text{fallback/direct-collapse BH screen} & M \\ge 25\\end{cases}")}</div>
      ...
      observations that M-dwarf activity varies less over magnetic cycles.</p>`)].join("")}function Ne(){return[a("Local Day Scale",`<div class="sci-formula__eq">${t("\\text{scale} = \\frac{P_{\\text{rot}}}{24}")}</div>
      ...
      ${s("Ortenzi et al. (2020), Sci. Rep. 10, 10907")}`)].join("")}function Ve(){return[a("Maximum Mountain Height",`<div class="sci-formula__eq">${t("H_{\\max} = \\frac{\\sigma_y}{\\rho \\cdot g} \\approx \\frac{9{,}267}{g} \\text{ m}")}</div>
    ...
    </div>`].join("")}function ze(){return[a("Mean-Motion Resonance Positions",`<div class="sci-formula__eq">${t("a_{\\text{res}} = a_p\\,(p/q)^{2/3}")}</div>
  ...
  `,i.innerHTML="",i.appendChild(r);let l=Array.from(r.querySelectorAll(".sci-section")),u=Array.from(r.querySelectorAll(".sci-formula")),f=Array.from(r.querySelectorAll(".sci-toc__link")),v=r.querySelector("#sciencePageSearch"),S=r.querySelector("#sciencePageSearchStatus"),M=r.querySelector("#sciencePageSearchResults"),P=Pe(r),R=null,C=!1,F=l.find(c=>c.open)?.id||l[0]?.id||null,A=(c,{exclusive:b=!C}={})=>{c&&(b?l.forEach(x=>{x.open=x===c}):c.open=!0,!C&&c.id&&(F=c.id))},G=()=>{R&&(clearTimeout(R),R=null),r.querySelectorAll(".sci-formula.is-search-hit").forEach(c=>{c.classList.remove("is-search-hit")})},H=c=>{if(!c)return;let b=r.querySelector(`#${c}`);if(!b)return;let x=b.closest(".sci-section");A(x),G(),b.classList.add("is-search-hit"),ee(b,{block:"center"}),b.focus?.({preventScroll:!0}),R=window.setTimeout(()=>{b.classList.remove("is-search-hit"),R=null},2200)},O=c=>{let b=W(c);if(G(),!b){C=!1,r.classList.remove("is-search-filtering"),u.forEach(y=>{y.hidden=!1,y.classList.remove("is-search-match","is-search-filtered-out")}),l.forEach(y=>{y.hidden=!1,y.classList.remove("is-search-match","is-search-filtered-out")}),f.forEach(y=>{y.hidden=!1,y.classList.remove("is-search-filtered-out")});let g=l.find(y=>y.id===F)||l[0]||null;return A(g,{exclusive:!0}),[]}let x=ge(P,b,P.length),$=new Set(x.map(g=>g.id)),k=new Set(x.map(g=>g.sectionId));return C=!0,r.classList.add("is-search-filtering"),u.forEach(g=>{let y=$.has(g.id);g.hidden=!y,g.classList.toggle("is-search-match",y),g.classList.toggle("is-search-filtered-out",!y)}),l.forEach(g=>{let y=k.has(g.id);g.hidden=!y,g.open=y,g.classList.toggle("is-search-match",y),g.classList.toggle("is-search-filtered-out",!y)}),f.forEach(g=>{let y=k.has(g.dataset.target||"");g.hidden=!y,g.classList.toggle("is-search-filtered-out",!y)}),x},N=(c,b=null)=>{if(!M||!S)return[];let x=W(c);if(!x)return M.hidden=!0,M.innerHTML="",S.hidden=!0,S.textContent="",[];let $=b||ge(P,x,P.length),k=$.slice(0,8);return S.hidden=!1,S.textContent=$.length>0?`${$.length} match${$.length===1?"":"es"}${$.length>k.length?`, showing top ${k.length}`:""}`:"No matches found",$.length===0?(M.hidden=!1,M.innerHTML='<div class="sci-search__empty">No formulas or topics matched that search.</div>',[]):(M.hidden=!1,M.innerHTML=k.map(g=>`
          ...
          </button>`).join(""),k)};l.forEach(c=>{c.addEventListener("toggle",()=>{if(c.open){if(!C&&c.id&&(F=c.id),C)return;l.forEach(b=>{b!==c&&(b.open=!1)})}})}),f.forEach(c=>{c.addEventListener("click",b=>{b.preventDefault();let x=c.dataset.target,$=r.querySelector(`#${x}`);$&&(A($),ee($,{block:"start"}))})}),v?.addEventListener("input",()=>{let c=O(v.value);N(v.value,c)}),v?.addEventListener("keydown",c=>{if(c.key!=="Enter")return;let b=O(v.value),[x]=N(v.value,b);x&&(c.preventDefault(),H(x.id))}),M?.addEventListener("click",c=>{let b=c.target.closest(".sci-search__result");b&&H(b.getAttribute("data-target-id"))}),Ze(r),he().then(c=>fe(r,c))}export{dt as initSciencePage};
