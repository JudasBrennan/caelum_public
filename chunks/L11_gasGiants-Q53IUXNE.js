import{a,b as e,c as r,d as s,e as h,f as i,g as o,h as n,i as b,j as w,k as f}from"./chunk-B66B57MG.js";import{A as y}from"./chunk-JAT3QFT3.js";import"./chunk-FFUDGKDT.js";function J(t){return[i("Two Families of Giants",`<p>Not all giant planets are alike. There are two broad families:</p>
      <ul>
      ...
      ${f("les11-radius","Estimated radius (R<sub>Jup</sub>): ")}`)].join("")}function _(t){let l=t.querySelector("#les11-mass"),p=t.querySelector("#les11-massSlider"),m=t.querySelector("#les11-radius");if(!l||!p||!m)return;function d(){let g=parseFloat(l.value)||1;p.value=g;let u=g*317.8,c;u<=131.6?c=.861*Math.pow(u,.53)/11.21:c=.861*Math.pow(131.6,.53)*Math.pow(131.6,.044)*Math.pow(u,-.044)/11.21,m.textContent=y(c,4)}l.addEventListener("input",d),p.addEventListener("input",()=>{l.value=p.value,d()}),d()}export{J as buildLesson11,_ as wireLesson11};
