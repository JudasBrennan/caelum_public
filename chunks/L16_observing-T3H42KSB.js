import{a as t,b as e,c as s,d as i,e as c,f as r,g as u,h as o,i as v,j as m,k as $}from"./chunk-B66B57MG.js";import{A as y}from"./chunk-JAT3QFT3.js";import"./chunk-FFUDGKDT.js";function T(a){return[r("Stellar Magnitudes",`<p>Astronomers measure the brightness of stars on a scale called
      ...
      ${$("les16-appmag","Apparent magnitude (m): ")}`)].join("")}function M(a){let l=a.querySelector("#les16-absmag"),d=a.querySelector("#les16-absmagSlider"),p=a.querySelector("#les16-dist"),h=a.querySelector("#les16-distSlider"),g=a.querySelector("#les16-appmag");if(!l||!d||!p||!h||!g)return;function n(){let b=parseFloat(l.value)||4.81,f=parseFloat(p.value)||10;d.value=b,h.value=f;let w=b+5*Math.log10(f)-5;g.textContent=y(w,2)}l.addEventListener("input",n),d.addEventListener("input",()=>{l.value=d.value,n()}),p.addEventListener("input",n),h.addEventListener("input",()=>{p.value=h.value,n()}),n()}export{T as buildLesson16,M as wireLesson16};
