import{a as g,b as e,c as h,d as a,e as r,f as s,g as n,h as o,i as m,j as p,k as f}from"./chunk-B66B57MG.js";import{A as d}from"./chunk-JAT3QFT3.js";import"./chunk-FFUDGKDT.js";function $(t){return[s("Stellar Flares",`<p>Stars are not perfectly steady light sources. From time to time, the
      ...
      ${f("les15-rate","Superflares per year (E &ge; 10<sup>33</sup> erg): ")}`)].join("")}function A(t){let i=t.querySelector("#les15-type"),l=t.querySelector("#les15-age"),u=t.querySelector("#les15-rate");if(!i||!l||!u)return;let y={FGK:{young:.8,mid:.1,old:.005},earlyM:{young:20,mid:3,old:.5},lateM:{young:80,mid:15,old:3}};function c(){let v=i.value,b=l.value,w=y[v]?.[b]??0;u.textContent=d(w,3)}i.addEventListener("input",c),l.addEventListener("input",c),c()}export{$ as buildLesson15,A as wireLesson15};
