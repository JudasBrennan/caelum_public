import{a as o,b as e,c as l,d as t,e as n,f as s,g as i,h as a}from"./chunk-L3XYPVN7.js";import"./chunk-VC46IEJQ.js";function u(r){return[s("The Rainbow of Stars",`<p>Stars are not all the same colour. Some blaze blue-white, others
      ...
      <p>Astronomers sort stars into a sequence of <strong>spectral
        ...
        Kiss Me."</em></p>
      ${i("A heating element on a stove follows the same pattern: it first glows dull red, then orange, then bright white as it gets hotter. Stars work the same way \u2014 colour reveals temperature.")}
      ${a("A star's colour is set by its surface temperature. The spectral sequence OBAFGKM runs from the hottest blue O-type stars (~40,000 K) down to cool red M-type stars (~3,000 K). Our Sun is a yellow-white G-type star.")}`,`<p>A star radiates approximately as a blackbody. The peak wavelength of
        its emission is governed by Wien's displacement law:</p>
      ${o("\\lambda_{\\text{max}} = \\frac{b}{T}")}
      ${l([["\\lambda_{\\text{max}}","peak emission wavelength (m)"],["b","Wien displacement constant (2.898 \\times 10^{-3}\\;\\text{m\\,K})"],["T","surface effective temperature (K)"]])}
      <p>The overall spectral energy distribution follows the Planck function:</p>
      ${o("B_\\lambda(T) = \\frac{2hc^2}{\\lambda^5}\\;\\frac{1}{e^{hc/(\\lambda k_B T)} - 1}")}
      ...
      ${t("Gray & Corbally (2009), Stellar Spectral Classification, Ch. 1-3")}`,r),s("Spectral Classes",`<p>Each spectral class covers a range of temperatures. Here is a
        summary of the main types:</p>
      ${n(["Class","Temperature (K)","Colour","Example"],[["O","30,000 -- 50,000+","Blue","Naos (Zeta Puppis)"],["B","10,000 -- 30,000","Blue-white","Rigel"],["A","7,500 -- 10,000","White","Sirius"],["F","6,000 -- 7,500","Yellow-white","Procyon"],["G","5,200 -- 6,000","Yellow","Sun"],["K","3,700 -- 5,200","Orange","Arcturus"],["M","2,400 -- 3,700","Red","Betelgeuse"]])}
      ${a("The spectral sequence OBAFGKM is a temperature sequence. Each class has distinctive absorption lines caused by elements in the star's atmosphere at that temperature.")}`,`<p>Spectral classification depends on the strengths of absorption lines
      ...
      ${n(["Class","T<sub>eff</sub> (K)","Colour","Example","Key lines"],[["O","30,000 -- 50,000+","Blue","Naos","He II, N III, C III"],["B","10,000 -- 30,000","Blue-white","Rigel","He I, H (moderate)"],["A","7,500 -- 10,000","White","Sirius","H Balmer (max), Mg II"],["F","6,000 -- 7,500","Yellow-white","Procyon","Ca II, Fe I, H (weaker)"],["G","5,200 -- 6,000","Yellow","Sun","Ca II (strong), Fe I, CH"],["K","3,700 -- 5,200","Orange","Arcturus","Ca I, Fe I, MgH"],["M","2,400 -- 3,700","Red","Betelgeuse","TiO, VO, CaOH"]])}
      ...
      ${t("Gray & Corbally (2009), Stellar Spectral Classification; Carroll & Ostlie (2017), Ch. 8")}`,r),s("The HR Diagram",`<p>If you plot every star on a chart with temperature on the horizontal
      ...
      ${i("Think of the HR diagram as a census map: it does not show where stars are in space, but where they are in their lives. Most are on the main sequence; the others have moved on to later stages.")}
      ${a("The HR diagram plots temperature against luminosity. Most stars lie on the main sequence. Giants sit above it and white dwarfs below it.")}`,`<p>The Hertzsprung-Russell diagram is the fundamental observational
        tool for stellar astrophysics. The observational version plots
        colour index (${e("B-V")}) or spectral type against absolute
        magnitude ${e("M_V")}; the theoretical version plots
        ${e("\\log T_{\\text{eff}}")} against ${e("\\log(L/L_\\odot)")}.</p>
      <p>Key features:</p>
      <ul>
      ...
      <p>Evolutionary tracks show how a star of a given mass moves across the
        HR diagram over time. A 1 ${e("M_\\odot")} star spends ~10 Gyr on
        the main sequence, then crosses the Hertzsprung gap in ~1 Gyr to
        ascend the RGB.</p>
      ${t("Kippenhahn, Weigert & Weiss (2012), Ch. 26; Hurley, Pols & Tout (2000, MNRAS 315, 543)")}`,r),s("Subtypes and Luminosity Classes",`<p>Each spectral letter is divided into numbered subtypes from 0
      ...
      ${a("Spectral subtypes (0--9) refine the temperature within each class. Luminosity classes (I--V) distinguish supergiants from dwarfs. The Sun is G2V.")}`,`<p>The <strong>Morgan-Keenan (MK) classification system</strong>
      ...
      ${n(["Luminosity class","Category","Typical log g"],[["Ia / Ib","Supergiant","0.0 -- 1.5"],["II","Bright giant","1.5 -- 2.5"],["III","Giant","2.5 -- 3.5"],["IV","Subgiant","3.5 -- 4.0"],["V","Dwarf (main sequence)","4.0 -- 4.5"]])}
      <p>Luminosity classes are distinguished spectroscopically by
        ...
        astrophysics.</p>
      ${t("Morgan, Keenan & Kellman (1943), An Atlas of Stellar Spectra; Gray & Corbally (2009), Ch. 5")}`,r)].join("")}export{u as buildLesson02};
