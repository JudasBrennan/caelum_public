import{a as o,b as t,c as n,d as i,e as p,f as s,g as c,h as a,i as S,j as h,k as q}from"./chunk-B66B57MG.js";import{A as R}from"./chunk-JAT3QFT3.js";import"./chunk-FFUDGKDT.js";function j(e){return[s("The Roche Limit",`<p>Every planet has an invisible danger zone close to its surface. If a
      ...
      ${n([["d_\\text{Roche}","orbital radius at which tidal disruption occurs"],["R_p","planet radius"],["\\rho_p","mean density of the planet"],["\\rho_m","mean density of the moon"]])}
      ...
      ${i("Roche (1849); Murray & Dermott (1999), Solar System Dynamics, Ch. 4")}`,e),s("The Hill Sphere",`<p>Just as there is a minimum distance (the Roche limit), there is also
      ...
      ${n([["r_\\text{Hill}","Hill sphere radius"],["a","planet's semi-major axis around the star"],["M_p","planet mass"],["M_\\star","stellar mass"]])}
      <p>In practice, moons are only stable well inside the Hill sphere. Caelum now uses a deliberately conservative long-term rule of thumb: roughly one-third of the Hill radius for prograde orbits, and about one-half for retrograde orbits, with an extra comfort margin before that outer edge. The exact stable region still depends on the full three-body context, but major regular moons usually sit far inside these limits.</p>
      ...
      ${i("Hamilton & Burns (1991, Icarus 92, 118); Murray & Dermott (1999), Solar System Dynamics, Ch. 9")}`,e),s("Tidal Locking",`<p>Our Moon always shows the same face to Earth. This is not a
      ...
      <p>Inside this radius, a prograde moon orbits faster than the parent
        ...
        parent normally pushes the moon outward. Caelum reports this as
        a bounded context check, with missing mass or rotation returning
        unknown rather than a confident fate.</p>
      ${i("Gladman et al. (1996, Icarus 122, 166); Peale (1999, ARA&A 37, 533)")}`,e),s("Tidal Heating",`<p>When a moon's orbit is not perfectly circular, its distance to the
      ...
      ${n([["\\dot{E}","tidal heating power (W)"],["k_2","satellite's tidal Love number (~0.03 for Io)"],["Q","tidal quality factor (~100 for Io)"],["G","gravitational constant (6.674 \\times 10^{-11})"],["M_p","planet mass"],["R_m","satellite radius"],["n","orbital mean motion = \\sqrt{G M_p / a^3}"],["e","orbital eccentricity"],["a","orbital semi-major axis"]])}
      ...
      <p>Caelum now labels that pump-damp balance qualitatively. Resonance
      ...
      ${i("Peale, Cassen & Reynolds (1979, Science 203, 892); Segatz et al. (1988, Icarus 75, 187)")}`,e),s("Orbital Fate",`<p>Tidal forces do not just heat moons \u2014 they also change their orbits
      ...
      ${n([["da/dt","rate of change of semi-major axis"],["\\Omega_p","planet spin angular velocity"],["n","moon's orbital mean motion"],["k_{2p}","planet's Love number"],["Q_p","planet's tidal quality factor"],["M_m","moon mass"],["R_p","planet radius"]])}
      ...
      <p>For systems with multiple modeled moons, Caelum also summarizes a
      ...
      <p>Caelum now adds a paper-informed <strong>cool-star surface calibration</strong> on top of those gates for exposed surface-life cases. That layer uses moon mass, host giant mass, parent orbital distance, composition, and spin state to decide whether the current moon sits in a defensible surface-habitable regime or below the current mass floor for an atmosphere-bearing exposed surface.</p>
      ...
      ${q("les12-heat","Tidal heating (TW): ")}`)].join("")}function P(e){let m=e.querySelector("#les12-mass"),y=e.querySelector("#les12-massSlider"),b=e.querySelector("#les12-moonR"),v=e.querySelector("#les12-moonRSlider"),w=e.querySelector("#les12-dist"),k=e.querySelector("#les12-distSlider"),x=e.querySelector("#les12-ecc"),M=e.querySelector("#les12-eccSlider"),_=e.querySelector("#les12-heat");if(!m||!_)return;function u(){let r=parseFloat(m.value)||318,l=parseFloat(b.value)||1822,T=parseFloat(w.value)||422e3,g=parseFloat(x.value)||.004;y.value=r,v.value=l,k.value=T,M.value=g;let $=6674e-14,f=r*5972e21,H=l*1e3,d=T*1e3,E=Math.sqrt($*f/(d*d*d)),C=21/2*(.03/100)*$*f*f*Math.pow(H,5)*E*g*g/Math.pow(d,6)/1e12;_.textContent=R(C,4)}let I=[[m,y],[b,v],[w,k],[x,M]];for(let[r,l]of I)r.addEventListener("input",u),l.addEventListener("input",()=>{r.value=l.value,u()});u()}export{j as buildLesson12,P as wireLesson12};
