import{a as V,b as de,c as he,d as pe,e as B}from"./chunk-5SAPJVLW.js";import{a as me,c as G,d as ge,f as Z}from"./chunk-HAAMVFBH.js";import"./chunk-BRNPJGEW.js";import"./chunk-DRLPC5MQ.js";import{b as re,c as ce}from"./chunk-HBNXX252.js";import"./chunk-JUK5PP3S.js";import{b as F}from"./chunk-ZI63CFXG.js";import"./chunk-BI755AXV.js";import{f as oe,g as le}from"./chunk-KM4G7NFN.js";import"./chunk-67BZ5CSS.js";import{c as U}from"./chunk-KBPV7C6X.js";import"./chunk-B5JT2W7P.js";import{a as m,d as K,e as y,f as se}from"./chunk-EHZCB5HO.js";import{a as T}from"./chunk-4DOSHAKO.js";import{$a as N,Bb as ne,Pa as E,_a as ae,ab as ie,da as j}from"./chunk-LXNIONG2.js";import{e as Y}from"./chunk-TR2TDQN3.js";import"./chunk-7MOERMFY.js";import"./chunk-CHI6BCHQ.js";import"./chunk-ILDN3TNT.js";import"./chunk-JY5EGEKT.js";import"./chunk-7WOMQQJ7.js";import"./chunk-4NRNBL6B.js";import"./chunk-5LTSFBYL.js";import"./chunk-QFPSSDPE.js";import"./chunk-CBTHXHPR.js";import"./chunk-7GQDESQ2.js";import"./chunk-QUJRDZK4.js";import"./chunk-IEW7HQ43.js";import"./chunk-MQPPEWJZ.js";import"./chunk-4SQRNXTG.js";import"./chunk-L3IA4LVI.js";import"./chunk-UNOVE7R7.js";import"./chunk-GLBR67F3.js";import"./chunk-Q3EXAOWE.js";import"./chunk-ASLSWSPR.js";import"./chunk-VW67QI3I.js";import"./chunk-HWHNMDED.js";import{C as A}from"./chunk-TXBNWBBK.js";import"./chunk-6DA3R6ZF.js";import"./chunk-RC2KHOII.js";import"./chunk-WLUJ3GDC.js";var g={"Max Peak Height":y({overview:"Maximum possible mountain peak height under the planet's gravity and crust type.",drawnFrom:"Surface gravity and crustal composition constant C in H_max = C / g.",feedsInto:"Mountain range caps, inactive-range erosion limits, and tectonic feature readouts.",interpretAs:"Lower gravity allows taller mountains. Earth-like C = 9,267 m; iron worlds 12,000 m; ice worlds 3,000 m.",caveat:"This is a gravity/material cap, not a terrain generator or local uplift model.",references:"See Science & Maths: tectonic relief and gravity scaling."}),"Mountain Type":`Convergent-boundary mountain range classification based on tectonic setting.

Andean: oceanic\u2013continental subduction (high volcanic arc + wide plateau). Laramide: flat-slab subduction (broad inland deformation, e.g. Rocky Mountains). Ural: continent\u2013continent collision (older, lower, no active volcanism). Himalayan: active continent\u2013continent collision (highest peaks, wide plateau).`,"Erosion Rate":y({overview:"Rate at which inactive mountain ranges lose height over geological time.",drawnFrom:"Planet surface temperature, atmospheric moisture/water-vapour context, water availability, climate state, and baseline rock-weathering assumptions.",feedsInto:"Inactive range height loss, old-mountain survival, tectonic summaries, and erosion warnings.",interpretAs:"Warmer, wetter worlds erode faster; cold, dry, or airless worlds erode more slowly. Output is reported in m/Myr.",caveat:"This is a global analytic rate, not a sediment-transport, glacier, river-network, or local rainfall model.",references:"See Science & Maths: climate erosion and tectonic relief."}),"Mid-Ocean Ridge Height":`Elevation of newly-formed oceanic crust at the spreading centre, measured from the abyssal plain reference.
...
Scales shield volcano heights and magmatic rift fill.`,"Climate Erosion":y({overview:"Erosion rate adjusted for climate and atmospheric moisture.",drawnFrom:"Surface temperature, atmospheric H2O, pressure/water context, and the active planet climate solve.",feedsInto:"Inactive mountain range decay and tectonic-factor summaries.",interpretAs:"Warmer and wetter worlds erode faster than cold, dry worlds.",caveat:"This is a broad climate modifier, not a detailed hydrology or sediment model.",references:"See Science & Maths: climate erosion."}),"Elastic Lithosphere":y({overview:"Thickness of the elastic lithosphere in km.",drawnFrom:"Planet age, mass/gravity, internal heat, radiogenic context, and tidal heating.",feedsInto:"Shield volcano flexural support, rift geometry, and tectonic-factor summaries.",interpretAs:"Thicker lithosphere supports taller volcanic edifices; tidal heating and high internal heat thin it.",caveat:"This is an effective elastic thickness, not a full lithosphere thermal model.",references:"See Science & Maths: lithosphere and solid-body response."}),"Arc Distance":`Distance from the oceanic trench to the volcanic arc (km). Computed as slab depth / tan(slab angle).
...
Shallower slopes produce much wider bases.`,"Rift Total Width":"Total width of the rift valley cross-section (km), including the graben floor, both fault scarps, volcanic fill, and uplifted shoulders."};Object.assign(g,{"Mountain Type":y({overview:"Convergent-boundary mountain range archetype.",drawnFrom:"Selected tectonic setting and the active mountain profile.",feedsInto:"Cross-section shape, zone labels, uplift style, and example interpretation.",caveat:"Archetypes are schematic and do not generate local terrain.",references:"See Science & Maths: tectonic relief and mountain types."}),"Mid-Ocean Ridge Height":y({overview:"Elevation of newly formed oceanic crust at the spreading centre.",drawnFrom:"The tectonics engine's ridge-height baseline and active spreading context.",feedsInto:"Ocean depth curve and ridge KPI readouts.",caveat:"It is a ridge-to-abyssal-plain guide, not a bathymetric map.",references:"See Science & Maths: oceanic plate cooling."}),"Ocean Depth Curve":y({overview:"Ocean-floor depth as oceanic crust ages and cools.",drawnFrom:"A two-regime plate-cooling model: young half-space cooling and older flattening.",interpretAs:"Depth increases with crust age, then approaches a mature-plate limit.",caveat:"Sedimentation, hotspots, trenches, and local crustal thickness are not mapped.",references:"Parsons & Sclater 1977; see Science & Maths: oceanic plate cooling."}),"Cross-Section":y({overview:"Schematic average-elevation profile across a mountain system.",drawnFrom:"Mountain type, convergence context, gravity/material caps, and zone templates.",interpretAs:"Zone averages can sit below individual peak limits.",caveat:"It is an explanatory cross-section, not a terrain generator.",references:"See Science & Maths: tectonic relief."}),"Inactive Range":y({overview:"Mountain range that is no longer actively uplifting.",drawnFrom:"Original height, age since activity ended, erosion rate, and max peak cap.",interpretAs:"Height decreases over time according to the configured/global erosion rate.",caveat:"Linear erosion is a global simplification, not local drainage or glaciation.",references:"See Science & Maths: climate erosion and tectonic relief."}),"Slab Angle":y({overview:"Dip angle of a subducting slab in degrees.",feedsInto:"Volcanic arc distance using d = slab depth / tan(angle).",interpretAs:"Steeper slabs place arcs closer to the trench; shallower slabs push arcs inland.",caveat:"The model uses a representative slab depth rather than a full subduction geometry.",references:"Syracuse & Abers 2006; see Science & Maths: tectonic relief."}),"Spreading Rate":y({overview:"Rate at which new oceanic crust is created at mid-ocean ridges.",feedsInto:"Ocean depth curve, ridge context, and tectonic activity summaries.",interpretAs:"Mobile-lid worlds can use Earth-like mm/yr ranges; stagnant-lid worlds trend to zero.",caveat:"This is a regime parameter, not a global plate reconstruction.",references:"Dalton et al. 2022; see Science & Maths: plate spreading."}),Pratt:y({overview:"Isostasy mode where topography is supported by lateral density differences.",feedsInto:"Mountain compensation interpretation and cross-section context.",caveat:"This is an idealised end-member, not a full crust/mantle density model.",references:"Pratt 1855; Turcotte & Schubert 2014."}),Isostasy:y({overview:"How topographic loads are compensated by the mantle.",changes:"Airy uses crustal roots; Pratt uses density differences at uniform compensation depth.",feedsInto:"Mountain root/compensation interpretation and cross-section summaries.",caveat:"Both modes are simplified end-members.",references:"Turcotte & Schubert 2014; see Science & Maths: isostasy."}),"Continental Margin":y({overview:"Transition from continent to deep ocean.",drawnFrom:"Shelf width, shelf break depth, slope angle, and margin profile settings.",feedsInto:"Margin width and continental margin chart.",caveat:"It is a schematic margin, not local bathymetry or sediment routing.",references:"See Science & Maths: continental margins."}),"Shield Volcano":y({overview:"Large, gently sloped volcano built by repeated lava flows.",drawnFrom:"Gravity limit, flexural lithosphere support, basal spreading, volcanic activity, and stagnant/mobile-lid context.",feedsInto:"Max shield height, shield volcano rows, and volcanic factor summaries.",caveat:"The model does not simulate magma plumbing, eruption chronology, or edifice collapse.",references:"McGovern & Solomon 1993/1998; see Science & Maths: shield volcano limits."}),"Rift Valley":y({overview:"Extensional feature where crust pulls apart and a graben drops down.",drawnFrom:"Graben width/depth, fault angle, volcanic fill, and shoulder uplift settings.",feedsInto:"Rift valley cross-section and rift summary readouts.",caveat:"It is a geometric tectonic profile, not a terrain mesh or stress simulation.",references:"See Science & Maths: rift geometry."}),"Planet Factors":y({overview:"Summary of planetary controls applied to tectonic features.",drawnFrom:"Gravity, composition, volcanic activity, climate erosion, elastic lithosphere, age, and heating context.",interpretAs:"Use this to see why the same feature differs between worlds.",caveat:"These are analytic controls, not a full mantle-convection or plate-tectonics simulation.",references:"See Science & Maths: tectonic relief and solid-body response."}),"Convergence Rate":y({overview:"Rate at which plates converge at a collision or subduction boundary.",feedsInto:"Mountain uplift scaling and active range height.",interpretAs:"Faster convergence drives taller ranges, with sub-linear scaling due to caps and erosion.",caveat:"The model does not solve stress accumulation or earthquake cycles.",references:"See Science & Maths: tectonic relief."}),Gravity:y({overview:"Surface gravity in Earth g.",drawnFrom:"Solved planet mass and radius.",feedsInto:"Maximum mountain height, shield volcano limits, and relief scaling.",caveat:"Gravity is global; local terrain strength is simplified by composition classes.",references:"See Science & Maths: gravity and relief scaling."}),Composition:y({overview:"Crustal material class used by tectonic relief limits.",drawnFrom:"Planet composition and derived crust/material context.",feedsInto:"Peak-height constant, mountain caps, and material interpretation.",caveat:"Material classes are broad; detailed mineralogy is not solved.",references:"See Science & Maths: rocky body composition."}),"Volcanic Activity":y({overview:"Combined volcanic activity index.",drawnFrom:"Radiogenic heating, age, tidal heating, and geodynamic context.",feedsInto:"Shield volcano height scaling, magmatic rift fill, and tectonic summaries.",caveat:"This is an activity scalar, not an eruption forecast.",references:"See Science & Maths: radiogenic and tidal heating."}),"Arc Distance":y({overview:"Distance from trench to volcanic arc.",drawnFrom:"Representative slab depth divided by tan(slab angle).",interpretAs:"Steeper slab angles produce arcs closer to the trench.",caveat:"Actual arcs vary with slab age, hydration, mantle flow, and convergence geometry.",references:"Syracuse & Abers 2006; see Science & Maths: subduction geometry."}),"Original Height":y({overview:"Initial elevation before an inactive range began eroding.",feedsInto:"Current inactive-range height after erosion over age.",caveat:"The original height is authored; the app does not reconstruct it from past tectonics."}),"Range Age":y({overview:"Time since an inactive range stopped actively forming.",feedsInto:"Cumulative height loss from erosion rate x age.",caveat:"Age is applied as a simple elapsed time, not a changing climate history.",references:"See Science & Maths: climate erosion."}),"Shield Height":y({overview:"Authored or capped height of a shield volcano.",drawnFrom:"Input height clamped by max shield height and activity/lithosphere limits.",caveat:"Local collapse, landslides, and caldera formation are not simulated.",references:"See Science & Maths: shield volcano limits."}),"Shield Slope":y({overview:"Average flank slope angle of a shield volcano.",feedsInto:"Base radius through R = H / tan(theta).",interpretAs:"Shallower slopes produce wider volcanic shields.",caveat:"Real volcano slopes vary by elevation, lava type, and flank stability.",references:"See Science & Maths: shield volcano geometry."}),"Graben Width":y({overview:"Width of the down-dropped rift block.",feedsInto:"Rift valley total width and cross-section geometry.",caveat:"It is a geometric control, not a crustal strain simulation.",references:"See Science & Maths: rift geometry."}),"Graben Depth":y({overview:"Depth of the rift floor below surrounding terrain.",feedsInto:"Rift valley relief and cross-section geometry.",caveat:"Sediment fill and erosion are not dynamically applied.",references:"See Science & Maths: rift geometry."}),"Fault Angle":y({overview:"Dip angle of the bounding normal faults.",feedsInto:"Rift geometry and width/depth interpretation.",interpretAs:"Steeper faults produce narrower grabens for the same depth.",caveat:"Fault networks are simplified to representative boundary faults.",references:"See Science & Maths: rift geometry."}),"Volcanic Fill":y({overview:"Thickness of lava or volcanic material filling the rift floor.",feedsInto:"Rift cross-section shape and apparent floor elevation.",caveat:"Composition, eruption timing, and flow emplacement are not simulated.",references:"See Science & Maths: rift geometry."}),"Shoulder Height":y({overview:"Uplift of rift shoulders above surrounding terrain.",feedsInto:"Rift cross-section relief.",caveat:"Isostatic/flexural rebound is simplified into one height control.",references:"See Science & Maths: rift geometry."}),"Shelf Width":y({overview:"Width of the continental shelf.",feedsInto:"Continental margin total width and margin chart.",caveat:"Shelf geometry is schematic and does not model sediment supply or sea-level history.",references:"See Science & Maths: continental margins."}),"Shelf Depth":y({overview:"Depth at the continental shelf break.",feedsInto:"Continental margin profile and slope geometry.",caveat:"The app uses a representative value rather than a glacioeustatic history.",references:"See Science & Maths: continental margins."}),"Margin Slope":y({overview:"Angle of the continental slope below the shelf break.",feedsInto:"Continental margin width and chart geometry.",caveat:"Active/passive margin complexity is compressed into one slope value.",references:"See Science & Maths: continental margins."}),"Ridge Height":y({overview:"Mid-ocean ridge elevation above the abyssal plain.",drawnFrom:"Ridge-height setting and oceanic crust model.",feedsInto:"Ocean depth curve and tectonic KPI rows.",caveat:"Hotspots, transform offsets, and local bathymetry are not represented.",references:"See Science & Maths: oceanic plate cooling."}),"Mean Ocean Depth":y({overview:"Estimated average liquid surface-ocean depth.",drawnFrom:"The selected planet's water inventory, inferred ocean coverage, climate state, and hydrosphere pressure context.",feedsInto:"Ocean chemistry, high-pressure ice risk, surface habitability, and downstream water-world interpretation.",interpretAs:"This is a global mean water-column depth over liquid ocean area, not a map of local trenches or basins.",caveat:"The current hydrosphere model does not solve true maximum local ocean depth.",references:"See Science & Maths: surface ocean coverage."}),"Mature Seafloor Depth":y({overview:"Old-oceanic-crust depth limit in the plate-cooling model.",drawnFrom:"Oceanic crust age-depth curve and mature-plate flattening limit.",interpretAs:"This describes where mature seafloor sits relative to sea level in the tectonics curve; it is separate from the planet's mean ocean depth.",caveat:"Trenches, sediment-loaded basins, sea-level changes, and true maximum water-column depth are not modelled as local features.",references:"Parsons & Sclater 1977; see Science & Maths: oceanic plate cooling."}),"Inferred Ocean Coverage":y({overview:"Science-model liquid-ocean surface fraction.",drawnFrom:"Planet water inventory, gravity-scaled relief, basin capacity, and climate state.",feedsInto:"Tectonic context and downstream climate/carbon-cycle science outputs.",caveat:"This is separate from authored visual/population ocean overrides.",references:"See Science & Maths: surface ocean coverage."}),"Authored Ocean Override":y({overview:"Manual ocean percentage from population or visual authoring.",drawnFrom:"Authored override value when present.",interpretAs:"It changes authored land/ocean split outputs without rewriting inferred science coverage.",caveat:"Climate, carbon-cycle, and tectonic science read the inferred coverage unless stated otherwise.",references:"See Science & Maths: surface ocean coverage."}),"Exposed Land":y({overview:"Estimated unflooded surface fraction after inferred basin fill.",drawnFrom:"Inferred ocean coverage and surface basin capacity context.",feedsInto:"Downstream science land context where available.",caveat:"This is not a terrain map or coastline generator.",references:"See Science & Maths: surface ocean coverage."}),"Cross-Section Width":y({overview:"Total width of the mountain cross-section.",drawnFrom:"The sum of active tectonic zone widths in the selected mountain profile.",caveat:"A schematic width, not a mapped orogen footprint."}),"Highest Zone":y({overview:"Average elevation of the highest zone in the mountain cross-section.",drawnFrom:"Selected mountain type, convergence scaling, and gravity/material caps.",caveat:"Individual peaks can exceed the zone average up to the max peak limit."}),"Margin Width":y({overview:"Total width from coast to abyssal plain.",drawnFrom:"Shelf, slope, and continental-rise geometry.",caveat:"Margin shape is schematic and not a coastline/bathymetry model.",references:"See Science & Maths: continental margins."}),"Base Radius":y({overview:"Horizontal distance from shield-volcano summit to base.",drawnFrom:"Volcano height and flank slope using R = H / tan(theta).",interpretAs:"Lower slopes produce broader bases.",caveat:"The volcano is treated as a simple conical/profile geometry.",references:"See Science & Maths: shield volcano geometry."}),"Rift Total Width":y({overview:"Total width of the rift valley cross-section.",drawnFrom:"Graben, fault scarp, volcanic fill, and shoulder geometry.",caveat:"This is profile geometry, not a map of rift segmentation.",references:"See Science & Maths: rift geometry."})});var J=["var(--accent)","var(--muted)","#7eb8a0","var(--warn)","#c49a8b","#8a9ac4"];function Se(s){let l=getComputedStyle(s);return J.map(i=>{if(i.startsWith("var(")){let a=i.slice(4,-1);return l.getPropertyValue(a).trim()||i}return i})}var ue=me();function ve(s){let l={gravityG:1,massEarth:1,ageGyr:4.6,surfaceTempK:288,h2oPct:0,compositionClass:"Earth-like",tidalHeatingWm2:0,radioisotopeAbundance:1,inferredOceanCoverageDisplay:"70.0%",meanOceanDepthDisplay:"n/a",meanOceanDepthMeta:"Planet hydrosphere unavailable",exposedLandDisplay:"30.0%",coverageConfidenceDisplay:"Fallback confidence",surfaceOceanCoverageReason:"fallback",authoredOceanOverrideDisplay:"Auto",authoredOceanOverrideActive:!1},i=N(s);if(!i)return l;let a=j(s,`planet:${i.id}`)||j(s,i.id),e=a?ce(s,a).model||a:null,d=e?oe(e,"tectonics"):null,u=d&&d.status!=="full"?le(e,"tectonics"):"";if(d?.status==="none")return{...l,unsupportedSurfaceMessage:u};let{model:r,starConfig:M}=re(s,i);if(!r?.derived)return l;let v=r.derived.climateSelection;if(v&&v.status!=="supported")return{...l,surfaceTempK:null,h2oPct:null,unsupportedSurfaceMessage:`Selected spectral climate is unavailable (${v.status}). ${v.issues.join(" ")}`};let P=s.population?.oceanPctOverride,R=P==null||P===""?null:Number(s.population.oceanPctOverride),D=Number.isFinite(R),C=D?Math.max(0,Math.min(100,R)):null;return{gravityG:r.derived.gravityG||1,massEarth:r.inputs?.massEarth||1,ageGyr:Number(M?.ageGyr)||4.6,surfaceTempK:v?v.temperatureK:r.derived.surfaceTempK||288,h2oPct:v?v.effectiveAtmosphere.gasMixPct.h2o:Number.isFinite(Number(r.inputs?.h2oPct))?Number(r.inputs.h2oPct):0,compositionClass:r.derived.compositionClass||"Earth-like",tidalHeatingWm2:r.derived.planetTidalHeatingWm2||0,radioisotopeAbundance:r.derived.radioisotopeAbundance??1,geodynamicsContext:r.derived.geodynamicsContext||null,inferredOceanCoverageDisplay:r.display?.inferredOceanCoverage||"n/a",meanOceanDepthDisplay:r.display?.meanOceanDepth||"n/a",meanOceanDepthMeta:r.display?.waterRegime||r.derived.waterRegime||"",exposedLandDisplay:r.display?.exposedLand||"n/a",coverageConfidenceDisplay:r.display?.surfaceOceanCoverageConfidence||"Unknown confidence",surfaceOceanCoverageReason:r.display?.surfaceOceanCoverageReason||r.derived.hydrosphere?.surfaceOceanCoverageContext?.source||"",authoredOceanOverrideDisplay:D?`${A(C,1)}%`:"Auto",authoredOceanOverrideActive:D,limitedSurfaceMessage:d?.status==="limited"?u:""}}function fe(s){let l=s?.geodynamicsContext;if(!l?.outputs)return"";let i=l.outputs,a=Array.isArray(l.limitingFactors)&&l.limitingFactors.length?` Limits: ${l.limitingFactors.join("; ")}`:"";return`<div class="derived-readout">Geodynamics: ${T(i.tectonicRegime||"unknown")}; heat ${T(i.internalHeatClass||"unknown")}; convection ${T(i.convectiveVigorClass||"unknown")}; weathering ${T(i.weatheringFeedbackClass||"unknown")}.${T(a)}</div>`}function ye(s){if(!s)return"";let l=s.authoredOceanOverrideActive?`Authored Ocean Override: ${s.authoredOceanOverrideDisplay} (manual land/ocean authoring; inferred science coverage remains separate)`:"Authored Ocean Override: Auto (uses inferred coverage)",i=s.meanOceanDepthDisplay&&s.meanOceanDepthDisplay!=="n/a"?`; mean ocean depth ${T(s.meanOceanDepthDisplay)}`:"",a=s.surfaceOceanCoverageReason?`; class ${T(s.surfaceOceanCoverageReason)}`:"";return`<div class="derived-readout">Surface ocean coverage: inferred ${T(s.inferredOceanCoverageDisplay||"n/a")}${i}; exposed land ${T(s.exposedLandDisplay||"n/a")}; ${T(s.coverageConfidenceDisplay||"Unknown confidence")}${a}. ${T(l)}</div>`}var be=["#5b9bd5","#3a7cc4","#2a5ea0","#1e3f6f"];function xe(s,l,i,a={}){let e=s.getContext("2d"),d=window.devicePixelRatio||1,u=s.clientWidth,r=s.clientHeight;s.width=u*d,s.height=r*d,e.scale(d,d);let M=Se(s),v={top:24,bottom:36,left:56,right:16},P=u-v.left-v.right,R=r-v.top-v.bottom,C=a.isostasyMode==="airy"||a.isostasyMode==="pratt"?Math.round(R*.2):0,_=R-C,c=l.totalWidthKm||1,t=i*1.15,h=P/c,n=_/t,p=getComputedStyle(s).getPropertyValue("color")||"#ccc",o=getComputedStyle(s).getPropertyValue("--muted")||"rgba(255,255,255,0.12)";e.clearRect(0,0,u,r),e.strokeStyle=o,e.lineWidth=.5;let b=z(t,5);for(let k=0;k<=t;k+=b){let $=v.top+_-k*n;e.beginPath(),e.moveTo(v.left,$),e.lineTo(v.left+P,$),e.stroke(),e.fillStyle=p,e.font="10px var(--font-mono, monospace)",e.textAlign="right",e.fillText(A(k,0),v.left-4,$+3)}let w=z(c,5);e.textAlign="center";for(let k=0;k<=c;k+=w){let $=v.left+k*h;e.fillStyle=p,e.font="10px var(--font-mono, monospace)",e.fillText(A(k,0),$,r-v.bottom+16)}e.save(),e.fillStyle=p,e.font="11px var(--font-mono, monospace)",e.textAlign="center",e.fillText("Width (km)",v.left+P/2,r-4),e.save(),e.translate(12,v.top+_/2),e.rotate(-Math.PI/2),e.fillText("Height (m)",0,0),e.restore(),e.restore();let S=v.top+_;e.strokeStyle="rgba(100,180,255,0.5)",e.lineWidth=1,e.setLineDash([4,4]),e.beginPath(),e.moveTo(v.left,S),e.lineTo(v.left+P,S),e.stroke(),e.setLineDash([]);let L=v.top+_-i*n;e.strokeStyle="rgba(255,100,100,0.5)",e.lineWidth=1,e.setLineDash([6,3]),e.beginPath(),e.moveTo(v.left,L),e.lineTo(v.left+P,L),e.stroke(),e.setLineDash([]),e.fillStyle="rgba(255,100,100,0.7)",e.font="10px var(--font-mono, monospace)",e.textAlign="right",e.fillText("Max "+A(i,0)+" m",v.left+P-2,L-4);for(let k=0;k<l.zones.length;k++){let $=l.zones[k],H=v.left+$.x*h,O=$.width*h,x=$.height*n;if(e.fillStyle=M[k%M.length],e.globalAlpha=.5,$.taper&&$.taperToPeak)e.beginPath(),e.moveTo(H,S),e.lineTo(H,S-$.minHeight*n),e.lineTo(H+O,S-x),e.lineTo(H+O,S),e.closePath(),e.fill();else if($.taper&&$.taperFromPeak)e.beginPath(),e.moveTo(H,S),e.lineTo(H,S-x),e.lineTo(H+O,S-$.minHeight*n),e.lineTo(H+O,S),e.closePath(),e.fill();else if($.taper){let f=k>0?l.zones[k-1]:null,I=k<l.zones.length-1?l.zones[k+1]:null,W=f?f.taperFromPeak?f.minHeight:f.height:0,q=I?I.taperToPeak?I.minHeight:I.height:0;e.beginPath(),e.moveTo(H,S),e.lineTo(H,S-W*n),e.lineTo(H+O,S-q*n),e.lineTo(H+O,S),e.closePath(),e.fill()}else e.fillRect(H,S-x,O,x);if(e.globalAlpha=1,O>30){let f=x;if($.taper&&!$.taperToPeak&&!$.taperFromPeak){let I=k>0?l.zones[k-1]:null,W=k<l.zones.length-1?l.zones[k+1]:null,q=I?I.taperFromPeak?I.minHeight:I.height:0,we=W?W.taperToPeak?W.minHeight:W.height:0;f=(q+we)/2*n}e.fillStyle=p,e.font="9px var(--font-mono, monospace)",e.textAlign="center",e.fillText($.name,H+O/2,S-f-4)}}if(C>0&&(e.fillStyle="rgba(139,94,60,0.06)",e.fillRect(v.left,S,P,C)),a.isostasyMode==="airy")for(let k=0;k<l.zones.length;k++){let $=l.zones[k];if($.height<=0)continue;let O=ge($.height)*n,x=v.left+$.x*h,f=$.width*h;e.fillStyle="#8b5e3c",e.globalAlpha=.35,e.fillRect(x,S,f,Math.min(O,C)),e.globalAlpha=1}else if(a.isostasyMode==="pratt"){let k=S+C*.7;e.strokeStyle="#8b5e3c",e.lineWidth=1.5,e.setLineDash([4,3]),e.beginPath(),e.moveTo(v.left,k),e.lineTo(v.left+P,k),e.stroke(),e.setLineDash([])}if(a.arcDistanceKm!=null&&a.arcDistanceKm<=c){let k=v.left+a.arcDistanceKm*h;e.strokeStyle="rgba(255,80,80,0.7)",e.lineWidth=1.5,e.setLineDash([3,3]),e.beginPath(),e.moveTo(k,v.top),e.lineTo(k,S),e.stroke(),e.setLineDash([]),e.fillStyle="rgba(255,80,80,0.85)",e.font="9px var(--font-mono, monospace)",e.textAlign="center",e.fillText("Arc "+A(a.arcDistanceKm,0)+" km",k,v.top+10)}}function Me(s,l,i){let a=s.getContext("2d"),e=window.devicePixelRatio||1,d=s.clientWidth,u=s.clientHeight;s.width=d*e,s.height=u*e,a.scale(e,e);let r={top:20,bottom:36,left:56,right:16},M=d-r.left-r.right,v=u-r.top-r.bottom,P=l[l.length-1]?.ageMyr||1e3,R=7e3,D=M/P,C=v/R,_=getComputedStyle(s).getPropertyValue("color")||"#ccc",c=getComputedStyle(s).getPropertyValue("--muted")||"rgba(255,255,255,0.12)";a.clearRect(0,0,d,u),a.strokeStyle=c,a.lineWidth=.5;let t=1e3;for(let o=0;o<=R;o+=t){let b=r.top+o*C;a.beginPath(),a.moveTo(r.left,b),a.lineTo(r.left+M,b),a.stroke(),a.fillStyle=_,a.font="10px var(--font-mono, monospace)",a.textAlign="right",a.fillText(A(o,0),r.left-4,b+3)}let h=z(P,5);a.textAlign="center";for(let o=0;o<=P;o+=h){let b=r.left+o*D;a.fillStyle=_,a.font="10px var(--font-mono, monospace)",a.fillText(A(o,0),b,u-r.bottom+16)}a.fillStyle=_,a.font="11px var(--font-mono, monospace)",a.textAlign="center",a.fillText("Crust Age (Myr)",r.left+M/2,u-4),a.save(),a.translate(12,r.top+v/2),a.rotate(-Math.PI/2),a.fillText("Depth (m)",0,0),a.restore();let n=r.top+i*C;a.strokeStyle="rgba(100,200,255,0.5)",a.lineWidth=1,a.setLineDash([4,4]),a.beginPath(),a.moveTo(r.left,n),a.lineTo(r.left+M,n),a.stroke(),a.setLineDash([]),a.fillStyle="rgba(100,200,255,0.7)",a.font="10px var(--font-mono, monospace)",a.textAlign="left",a.fillText("Ridge "+A(i,0)+" m",r.left+4,n-4);let p=r.top+6400*C;a.strokeStyle="rgba(255,150,100,0.5)",a.lineWidth=1,a.setLineDash([4,4]),a.beginPath(),a.moveTo(r.left,p),a.lineTo(r.left+M,p),a.stroke(),a.setLineDash([]),a.fillStyle="rgba(255,150,100,0.7)",a.font="10px var(--font-mono, monospace)",a.textAlign="left",a.fillText("Max 6,400 m",r.left+4,p-4),a.strokeStyle="var(--accent, #66aaff)",a.lineWidth=2,a.beginPath();for(let o=0;o<l.length;o++){let b=l[o],w=r.left+b.ageMyr*D,S=r.top+b.depthM*C;o===0?a.moveTo(w,S):a.lineTo(w,S)}a.stroke(),a.fillStyle="rgba(30,90,160,0.15)",a.beginPath(),a.moveTo(r.left,r.top);for(let o of l)a.lineTo(r.left+o.ageMyr*D,r.top+o.depthM*C);a.lineTo(r.left+M,r.top),a.closePath(),a.fill()}function z(s,l){let i=s/l,a=Math.pow(10,Math.floor(Math.log10(i))),e=i/a,d;return e<=1.5?d=1:e<=3.5?d=2:e<=7.5?d=5:d=10,d*a}function ke(s,l){let i=s.getContext("2d"),a=window.devicePixelRatio||1,e=s.clientWidth,d=s.clientHeight;s.width=e*a,s.height=d*a,i.scale(a,a);let u={top:20,bottom:36,left:56,right:16},r=e-u.left-u.right,M=d-u.top-u.bottom,v=l.totalWidthKm||500,P=5500,R=r/v,D=M/P,C=getComputedStyle(s).getPropertyValue("color")||"#ccc",_=getComputedStyle(s).getPropertyValue("--muted")||"rgba(255,255,255,0.12)";i.clearRect(0,0,e,d),i.strokeStyle=_,i.lineWidth=.5;let c=1e3;for(let h=0;h<=P;h+=c){let n=u.top+h*D;i.beginPath(),i.moveTo(u.left,n),i.lineTo(u.left+r,n),i.stroke(),i.fillStyle=C,i.font="10px var(--font-mono, monospace)",i.textAlign="right",i.fillText(A(h,0),u.left-4,n+3)}let t=z(v,5);i.textAlign="center";for(let h=0;h<=v;h+=t){let n=u.left+h*R;i.fillStyle=C,i.font="10px var(--font-mono, monospace)",i.fillText(A(h,0),n,d-u.bottom+16)}i.fillStyle=C,i.font="11px var(--font-mono, monospace)",i.textAlign="center",i.fillText("Distance from Coast (km)",u.left+r/2,d-4),i.save(),i.translate(12,u.top+M/2),i.rotate(-Math.PI/2),i.fillText("Depth (m)",0,0),i.restore();for(let h=0;h<l.segments.length;h++){let n=l.segments[h],p=u.left+n.startKm*R,o=u.left+n.endKm*R,b=u.top+n.startM*D,w=u.top+n.endM*D;i.fillStyle=be[h%be.length],i.globalAlpha=.3,i.beginPath(),i.moveTo(p,u.top),i.lineTo(p,b),i.lineTo(o,w),i.lineTo(o,u.top),i.closePath(),i.fill(),i.globalAlpha=1;let S=(p+o)/2;o-p>30&&(i.fillStyle=C,i.font="9px var(--font-mono, monospace)",i.textAlign="center",i.fillText(n.name,S,u.top+14))}i.strokeStyle="var(--accent, #66aaff)",i.lineWidth=2,i.beginPath();for(let h=0;h<l.points.length;h++){let n=l.points[h],p=u.left+n.distKm*R,o=u.top+n.depthM*D;h===0?i.moveTo(p,o):i.lineTo(p,o)}i.stroke()}function Re(s,l,i){let a=s.getContext("2d"),e=window.devicePixelRatio||1,d=s.clientWidth,u=s.clientHeight;s.width=d*e,s.height=u*e,a.scale(e,e);let r={top:20,bottom:36,left:56,right:16},M=d-r.left-r.right,v=u-r.top-r.bottom,P=15,D=v/((i||1e4)*1.15),C=D*1e3/P,_=l.baseRadiusKm*2.2*C,c=_>M?M/_:1,t=D*c,h=C*c,n=getComputedStyle(s).getPropertyValue("color")||"#ccc";a.clearRect(0,0,d,u);let p=r.top+v;a.strokeStyle="rgba(100,180,255,0.3)",a.lineWidth=1,a.setLineDash([4,4]),a.beginPath(),a.moveTo(r.left,p),a.lineTo(r.left+M,p),a.stroke(),a.setLineDash([]);let o=r.left+M/2;a.fillStyle="#c49a8b",a.globalAlpha=.5,a.beginPath(),a.moveTo(o-l.baseRadiusKm*h,p);for(let w of l.points)a.lineTo(o-w.rKm*h,p-w.hM*t);for(let w=l.points.length-1;w>=0;w--){let S=l.points[w];a.lineTo(o+S.rKm*h,p-S.hM*t)}a.lineTo(o+l.baseRadiusKm*h,p),a.closePath(),a.fill(),a.globalAlpha=1,a.strokeStyle="var(--accent, #66aaff)",a.lineWidth=1.5,a.beginPath(),a.moveTo(o-l.baseRadiusKm*h,p);for(let w of l.points)a.lineTo(o-w.rKm*h,p-w.hM*t);for(let w=l.points.length-1;w>=0;w--){let S=l.points[w];a.lineTo(o+S.rKm*h,p-S.hM*t)}a.lineTo(o+l.baseRadiusKm*h,p),a.stroke(),a.fillStyle=n,a.font="11px var(--font-mono, monospace)",a.textAlign="center",a.fillText("Radius (km)",o,u-4);let b=l.points[l.points.length-1]?.hM||0;a.fillText(A(b,0)+" m",o,p-b*t-6)}function $e(s,l){let i=s.getContext("2d"),a=window.devicePixelRatio||1,e=s.clientWidth,d=s.clientHeight;s.width=e*a,s.height=d*a,i.scale(a,a);let u={top:24,bottom:36,left:56,right:16},r=e-u.left-u.right,M=d-u.top-u.bottom,v=l.totalWidthKm||1,P=0,R=0;for(let n of l.zones)n.height<P&&(P=n.height),n.height>R&&(R=n.height);let D=(R-P)*1.3||1,C=r/v,_=M/D,c=u.top+R*1.15*_,t=getComputedStyle(s).getPropertyValue("color")||"#ccc";i.clearRect(0,0,e,d),i.strokeStyle="rgba(100,180,255,0.4)",i.lineWidth=1,i.setLineDash([4,4]),i.beginPath(),i.moveTo(u.left,c),i.lineTo(u.left+r,c),i.stroke(),i.setLineDash([]);let h=["#8b7355","#a05a3c","#6b3a2a","#a05a3c","#8b7355"];for(let n=0;n<l.zones.length;n++){let p=l.zones[n],o=u.left+p.x*C,b=p.width*C,w=p.height*_;if(i.fillStyle=h[n%h.length],i.globalAlpha=.5,p.taper&&p.taperFromPeak?(i.beginPath(),i.moveTo(o,c),i.lineTo(o,c-(l.zones[0]?.height||0)*_),i.lineTo(o+b,c-w),i.lineTo(o+b,c),i.closePath(),i.fill()):p.taper&&p.taperToPeak?(i.beginPath(),i.moveTo(o,c),i.lineTo(o,c-w),i.lineTo(o+b,c-(l.zones[4]?.height||0)*_),i.lineTo(o+b,c),i.closePath(),i.fill()):i.fillRect(o,c-w,b,w<0?-w:w),i.globalAlpha=1,b>30){i.fillStyle=t,i.font="9px var(--font-mono, monospace)",i.textAlign="center";let S=w>=0?c-w-4:c-w+12;i.fillText(p.name,o+b/2,S)}}i.fillStyle=t,i.font="11px var(--font-mono, monospace)",i.textAlign="center",i.fillText("Width (km)",u.left+r/2,d-4)}var Te=[{title:"Getting Started",body:"The Tectonics page models crustal features from plate dynamics. Select a mountain range type, set convergence parameters, and review the resulting elevation profile."},{title:"Mountain Types",body:"Choose from Andean (subduction), Laramide (flat-slab), Ural (ancient collision), or Himalayan (active collision). Each type produces a distinct cross-section and peak height."},{title:"Ocean and Margins",body:"Model continental margins with shelf width, slope angle, and abyssal depth. Ocean depth curves depend on plate age and spreading rate."},{title:"Volcanoes",body:"Configure shield volcanoes, hotspot chains, and rift valleys. Elastic lithosphere thickness and tidal heating affect maximum volcano height."},{title:"Plate Canvas",body:"Generate Voronoi plate boundaries with classification as convergent, divergent, or transform. Use this to sketch a tectonic map for your world."}];function te(s){return s?.name||s?.inputs?.name||s?.id||"No compatible planet"}function Ae(s=[],l=null){return s.map(i=>({value:i.id,label:te(i),selected:i.id===l?.id}))}function X({selected:s,ctx:l,model:i,regime:a="",unsupportedMessage:e="",empty:d=!1}={}){return V(de({id:"tectonicsCockpit",title:"Tectonics",summary:d?"Create a rocky planet before reading tectonic and terrain limits.":"Reads the selected rocky planet, then interprets terrain limits and local feature profiles.",current:{label:"Selected planet",value:d?"No compatible planet":te(s),meta:e?"Tectonic output is unavailable for this body.":"Tectonic diagnostic target."},statusItems:[{label:"Reads from",value:"Planets",meta:"Mass, gravity, water, tectonic regime, geodynamics, and surface class."},{label:"Diagnostic only",value:e?"Unsupported":i?.display?.maxPeakHeight||"Waiting",meta:a?`Regime: ${a}. Local feature profiles save to Tectonics.`:"",tone:e?"warn":""},{label:"Authoring override",value:l?.authoredOceanOverrideDisplay||"Auto",meta:l?.authoredOceanOverrideActive?"Population/visual override; inferred science coverage remains separate.":"Auto follows inferred coverage."}],source:{label:"Source",value:"Reads from Planets",meta:"Change inputs on Planets. This page is diagnostic only for planet science."},details:{id:"tectonicsContextDisclosure",title:"What this reads",summary:"Planet mass, water, tectonic regime, geodynamics, and ocean coverage context.",items:["Reads from Planets: mass, gravity, age, water, geodynamics, tectonic regime, and surface classification.","Change inputs on Planets: edit mass, water coverage, radioisotopes, tidal heating, and tectonic regime there.","Diagnostic only: terrain profile controls here do not rewrite planet science context.","Authoring override: population/visual ocean overrides remain separate from inferred surface-ocean coverage."]},nextStep:{id:"tectonicsNextStepStrip",recommendation:d?"Create a rocky planet, then return here to inspect terrain limits.":"Edit mass, water, or tectonic regime on Planets when these limits need to change.",actions:[{label:"Edit planet",href:"#/planet",primary:!0},{label:"Open Climate",href:"#/climate"},{label:"Open Population",href:"#/population"}]}}))}function Q(){return V(he({id:"tectonicsDependencyNotice",title:"Reads from Planets",body:"Reads from the selected rocky planet's mass, water coverage, geodynamics, and tectonic regime. Change inputs on Planets.",source:"Diagnostic only for planet science. Authoring override ocean values stay separate from inferred tectonic and climate coverage.",actions:[{label:"Change inputs on Planets",href:"#/planet"}]}))}function ee(s,l,i){return V(pe({id:"tectonicsObjectSelector",title:"Planet selection",summary:"Choose the rocky planet whose terrain limits and tectonic context should be interpreted.",selectedLabel:"Selected planet",selectedValue:te(l),selectedMeta:i?.unsupportedSurfaceMessage?"No compatible tectonic output for this body.":"Tectonic diagnostic target.",selectId:"tecPlanetSelect",selectLabel:"Planet",selectOptions:Ae(s,l)}))}function Pe(s,l){return`
      <div class="page">
        <div class="panel">
              ...
              ${t?`
                <div class="subsection">
                  ...
                  <div class="tec-isostasy-toggle">
                    ...
                    <span class="action-with-help"><button class="tec-iso-btn ${e.isostasyMode==="airy"?"is-active":""}" data-iso="airy">Airy</button>${m(g.Isostasy).replace('aria-label="Show help"','aria-label="Help for Airy isostasy"')}</span>
                    <span class="action-with-help"><button class="tec-iso-btn ${e.isostasyMode==="pratt"?"is-active":""}" data-iso="pratt">Pratt</button>${m(g.Pratt).replace('aria-label="Show help"','aria-label="Help for Pratt isostasy"')}</span>
                  </div>
                  ...
                  ${F([{labelHtml:`Total Width ${m(g["Cross-Section Width"])}`,value:`${A(t.totalWidthKm,0)} km`},{labelHtml:`Highest Zone Avg. ${m(g["Highest Zone"])}`,value:`${A(t.peakM,0)} m`},...n!=null?[{labelHtml:`Arc Distance ${m(g["Arc Distance"])}`,value:`${A(n,0)} km`}]:[]])}
                </div>
              ...
              ${c.tectonics.shieldProfiles.length?`
                <div class="subsection">
                  ...
                  ${c.tectonics.shieldProfiles.map((o,b)=>`<canvas id="tecShieldCanvas${b}" class="tec-canvas" style="height:180px"></canvas>
                      ${F([{labelHtml:`Height ${m(g["Shield Height"])}`,value:`${A(o.heightM,0)} m`},{labelHtml:`Base Radius ${m(g["Base Radius"])}`,value:`${A(o.baseRadiusKm,0)} km`}])}`).join("")}
                </div>
              `:""}
              ...
              ${c.tectonics.riftProfiles.length?`
                <div class="subsection">
                  ...
                  ${c.tectonics.riftProfiles.map((o,b)=>`<canvas id="tecRiftCanvas${b}" class="tec-canvas" style="height:200px"></canvas>
                      ${F([{labelHtml:`Total Width ${m(g["Rift Total Width"])}`,value:`${A(o.totalWidthKm,0)} km`}])}`).join("")}
                </div>
              `:""}
          ...
          <div class="panel">
            ...
            <div class="panel__body" id="tecInputs">
              ...
              <details class="subsection" style="margin-top:8px">
                <summary><h3 style="display:inline">Planet Factors</h3></summary>
                ${m(g["Planet Factors"]).replace('aria-label="Show help"','aria-label="Help for Planet Factors"')}
                <div class="kpi-grid" style="margin-top:8px">
                  <div class="kpi-wrap"><div class="kpi">
              ...
              <div class="subsection">
                ...
                <div id="tecRangeCards">
                  ${e.mountainRanges.map((x,f)=>`
                    <div class="tec-range-card ${f===b?"is-selected":""}" data-idx="${f}">
                      <div class="tec-range-card__header">
                        <select class="tec-type-select" data-idx="${f}" aria-label="Mountain range ${f+1} type">
                          ${ue.map(I=>`<option value="${I.key}" ${x.type===I.key?"selected":""}>${T(I.label)}</option>`).join("")}
                        </select>
                        <button class="tec-range-remove" data-idx="${f}" title="Remove range">&times;</button>
                      </div>
                      ${x.type==="andean"||x.type==="laramide"?`
                        <div class="form-row">
                          <div><div class="label">Slab Angle ${m(g["Slab Angle"])} <span class="unit">\xB0</span></div></div>
                          <div class="input-pair">
                            <input type="number" class="tec-slab-angle" data-idx="${f}" value="${x.slabAngleDeg||45}" min="10" max="90" step="1" />
                            <input type="range" class="tec-slab-angle-slider" data-idx="${f}" value="${x.slabAngleDeg||45}" min="10" max="90" step="1" />
                          </div>
                        </div>
                      ...
                      <div class="form-row">
                        ...
                        <div class="input-pair">
                          <input type="number" class="tec-convergence" data-idx="${f}" value="${x.convergenceMmYr||50}" min="10" max="100" step="1" />
                          <input type="range" class="tec-convergence-slider" data-idx="${f}" value="${x.convergenceMmYr||50}" min="10" max="100" step="1" />
                        </div>
                      </div>
                    </div>
                  `).join("")}
              ...
              <div class="subsection">
                ...
                <div id="tecInactiveCards">
                  ${e.inactiveRanges.map((x,f)=>`
                    <div class="tec-range-card">
                      <div class="tec-range-card__header">
                        <select class="tec-inactive-type" data-idx="${f}" aria-label="Inactive mountain range ${f+1} type">
                          ${ue.map(I=>`<option value="${I.key}" ${x.type===I.key?"selected":""}>${T(I.label)}</option>`).join("")}
                        </select>
                        <button class="tec-inactive-remove" data-idx="${f}" title="Remove">&times;</button>
                      </div>
                      <div class="form-row">
                        <div><div class="label">Original Height <span class="unit">m</span> ${m(g["Original Height"])}</div></div>
                        <input type="number" class="tec-inactive-height" data-idx="${f}" value="${x.originalHeightM||5e3}" min="0" max="100000" step="100" />
                      </div>
                      <div class="form-row">
                        <div><div class="label">Age <span class="unit">Myr</span> ${m(g["Range Age"])}</div></div>
                        <input type="number" class="tec-inactive-age" data-idx="${f}" value="${x.ageMyr||0}" min="0" max="10000" step="1" />
                      </div>
                      <div class="form-row">
                        <div><div class="label">Erosion Rate ${m(g["Erosion Rate"])} <span class="unit">m/Myr</span></div></div>
                        <input type="number" class="tec-inactive-erosion" data-idx="${f}" value="${x.erosionRate||5}" min="0" max="100" step="0.5" />
                      </div>
                    </div>
                  `).join("")}
                </div>
              ...
              <div class="subsection">
                ...
                <div id="tecShieldCards">
                  ${e.shieldVolcanoes.map((x,f)=>`
                    <div class="tec-range-card">
                      <div class="tec-range-card__header">
                        <span class="label">Shield ${f+1}</span>
                        <button class="tec-shield-remove" data-idx="${f}" title="Remove">&times;</button>
                      </div>
                      <div class="form-row">
                        <div><div class="label">Height <span class="unit">m</span> ${m(g["Shield Height"])}</div></div>
                        <div class="input-pair">
                          <input type="number" class="tec-shield-height" data-idx="${f}" value="${x.heightM||5e3}" min="100" max="${Math.round(o.tectonics.maxShieldHeightM)}" step="100" />
                          <input type="range" class="tec-shield-height-slider" data-idx="${f}" value="${x.heightM||5e3}" min="100" max="${Math.round(o.tectonics.maxShieldHeightM)}" step="100" />
                        </div>
                      </div>
                      <div class="form-row">
                        <div><div class="label">Slope <span class="unit">\xB0</span> ${m(g["Shield Slope"])}</div></div>
                        <div class="input-pair">
                          <input type="number" class="tec-shield-slope" data-idx="${f}" value="${x.slopeAngleDeg||5}" min="1" max="15" step="0.5" />
                          <input type="range" class="tec-shield-slope-slider" data-idx="${f}" value="${x.slopeAngleDeg||5}" min="1" max="15" step="0.5" />
                        </div>
                      </div>
                    </div>
                  `).join("")}
              ...
              <div class="subsection">
                ...
                <div id="tecRiftCards">
                  ${e.riftValleys.map((x,f)=>`
                    <div class="tec-range-card">
                      <div class="tec-range-card__header">
                        <span class="label">Rift ${f+1}</span>
                        <button class="tec-rift-remove" data-idx="${f}" title="Remove">&times;</button>
                      </div>
                      <div class="form-row">
                        <div><div class="label">Width <span class="unit">km</span> ${m(g["Graben Width"])}</div></div>
                        <input type="number" class="tec-rift-width" data-idx="${f}" value="${x.grabenWidthKm||50}" min="5" max="300" step="5" />
                      </div>
                      <div class="form-row">
                        <div><div class="label">Depth <span class="unit">m</span> ${m(g["Graben Depth"])}</div></div>
                        <input type="number" class="tec-rift-depth" data-idx="${f}" value="${x.grabenDepthM||1e3}" min="50" max="5000" step="50" />
                      </div>
                      <div class="form-row">
                        <div><div class="label">Fault Angle <span class="unit">\xB0</span> ${m(g["Fault Angle"])}</div></div>
                        <input type="number" class="tec-rift-angle" data-idx="${f}" value="${x.faultAngleDeg||60}" min="20" max="80" step="1" />
                      </div>
                      <div class="form-row">
                        <div><div class="label">Volcanic Fill <span class="unit">m</span> ${m(g["Volcanic Fill"])}</div></div>
                        <input type="number" class="tec-rift-fill" data-idx="${f}" value="${x.volcanicFillM||0}" min="0" max="5000" step="50" />
                      </div>
                      <div class="form-row">
                        <div><div class="label">Shoulder Height <span class="unit">m</span> ${m(g["Shoulder Height"])}</div></div>
                        <input type="number" class="tec-rift-shoulder" data-idx="${f}" value="${x.shoulderHeightM||0}" min="0" max="3000" step="50" />
                      </div>
                    </div>
                  `).join("")}
                </div>
