import{a as K,e as le}from"./chunk-5SAPJVLW.js";import"./chunk-BRNPJGEW.js";import{a as oe}from"./chunk-DRLPC5MQ.js";import"./chunk-JUK5PP3S.js";import"./chunk-BI755AXV.js";import{a as F,d as se}from"./chunk-W3EYRFLF.js";import{b as te,d as ne}from"./chunk-WWXWW5PU.js";import{e as re,f as ie}from"./chunk-VGAEQJV7.js";import{b as H}from"./chunk-A2IDG6ZU.js";import"./chunk-4PCYZBDH.js";import"./chunk-IXVEL6NR.js";import"./chunk-HKW5LTOD.js";import"./chunk-COLLAGLN.js";import"./chunk-K2Z3DHSB.js";import"./chunk-FA6IWSSY.js";import"./chunk-Q4W4SK6X.js";import{a as X}from"./chunk-EHRPTLYW.js";import{a as d,d as ee,e as L,f as ae}from"./chunk-EHZCB5HO.js";import"./chunk-326UE2JN.js";import{e as Z}from"./chunk-H2TA4Z36.js";import{b as y,c as P,e as D}from"./chunk-TR2TDQN3.js";import{Oa as z,_a as Y}from"./chunk-YAEK6ERI.js";import"./chunk-7E52UATC.js";import"./chunk-SHSQGNVA.js";import"./chunk-YCCSK56V.js";import"./chunk-7MXKMM6I.js";import"./chunk-WOH46XOU.js";import"./chunk-HI5MUYK2.js";import"./chunk-GAYVSXB7.js";import"./chunk-75A3ODDT.js";import"./chunk-CBTHXHPR.js";import"./chunk-46BNNGNQ.js";import"./chunk-CDKO4QWB.js";import"./chunk-HYNVHEYD.js";import"./chunk-DAOTPOVK.js";import"./chunk-CH7OG2WY.js";import"./chunk-LHEZNGZ5.js";import"./chunk-NYJOF3NP.js";import"./chunk-Q3EXAOWE.js";import"./chunk-ASLSWSPR.js";import"./chunk-MTXM7GCO.js";import"./chunk-JVOZJUGE.js";import{A as h}from"./chunk-JAT3QFT3.js";import"./chunk-6DA3R6ZF.js";import"./chunk-RC2KHOII.js";import"./chunk-5RCZOBSY.js";function Be(e){return e?y("span",{className:"tip-icon",attrs:{tabindex:"0",role:"note","aria-label":"Info"},dataset:{tip:e},text:"i"}):null}function u(e,a={}){return y("td",{attrs:a,text:e==null?"":String(e)})}function xe(e){return e?.angDiamArcmin!=null?`${Number(e.angDiamArcmin).toFixed(1)}\u2032`:e?.angDiamArcsec!=null?`${e.angDiamArcsec}\u2033`:"\u2014"}function Ee(e){let a=String(e?.classLabel||"").trim(),t=String(e?.bodyTypeLabel||"").trim();return/brown dwarf/i.test(a)?a:t||a}function Te(e){let a=y("input",{className:"cluster-name-input",attrs:{type:"number",min:e?.minDistanceAu,max:e?.maxDistanceAu,step:"0.001",title:`min ${h(e?.minDistanceAu,3)} AU, max ${h(e?.maxDistanceAu,3)} AU`},dataset:{distanceId:e?.id||""}});return a.value=String(e?.currentDistanceAu??""),a}function ue(e,a=[],t=""){let s=Array.isArray(a)?a:[];if(!s.length)return D(e,[{value:"",label:"No planets"}]),e.value="","";let o=new Set(s.map(f=>String(f?.id||"")).filter(Boolean)).has(String(t||""))?String(t||""):String(s[0]?.id||"");return D(e,s.map(f=>({value:f?.id||"",label:f?.name||f?.id||"Planet"}))),e.value=o,o}function pe(e){let a=e?.kind==="moon"&&e?.parentName?`${e.label} (${e.parentName})`:e?.label||e?.id||"Reference body";return y("option",{attrs:{value:e?.selectValue||""},text:a})}function me(e,a=[],t=""){let s=(Array.isArray(a)?a:[]).filter(g=>g&&g.eligibilityClass!=="invalid");if(!s.length)return D(e,[{value:"",label:"No reference bodies"}]),e.value="","";let i={planet:s.filter(g=>g.kind!=="moon"),moon:s.filter(g=>g.kind==="moon")},o=[];i.planet.length&&o.push(y("optgroup",{attrs:{label:"Planets"}},i.planet.map(g=>pe(g)))),i.moon.length&&o.push(y("optgroup",{attrs:{label:"Moons"}},i.moon.map(g=>pe(g))));let S=new Set(s.map(g=>g.selectValue)).has(String(t||""))?String(t||""):s[0]?.selectValue||"";return P(e,o),e.value=S,S}function ce(e,a=[],t={}){return P(e,(Array.isArray(a)?a:[]).map(s=>y("div",{className:"kpi-wrap"},[y("div",{className:"kpi"},[y("div",{className:"kpi__label"},[s?.label||"",t?.[s?.label]?" ":"",Be(t?.[s?.label]||"")]),y("div",{className:"kpi__value",text:s?.value??""}),y("div",{className:"kpi__meta",text:s?.meta??""})])]))),e}function he(e,a=[]){return P(e,(Array.isArray(a)?a:[]).map(t=>y("tr",{},[u(t?.name),u(h(t?.orbitAu,4)),u(h(t?.magnitude,4)),u(h(t?.brightnessRelativeToEarthSun,6)),u(h(t?.apparentSizeRelativeToEarthSun,6)),u(t?.angularDiameterLabel)]))),e}function be(e,a=[]){return P(e,(Array.isArray(a)?a:[]).map(t=>y("tr",{},[u(t?.name),u(Ee(t)),y("td",{},[Te(t)]),u(h(t?.phaseAngleDeg,2)),u(Number.isFinite(t?.apparentMagnitude)?h(t.apparentMagnitude,2):"NA"),u(t?.angularDiameterLabel),u(t?.observable),u(t?.visibility)]))),e}function ye(e,a=[]){let t=Array.isArray(a)?a:[];return t.length?(P(e,t.map(s=>y("tr",{},[u(s?.name),u(h(s?.absoluteMagnitude,4)),u(Number.isFinite(s?.apparentMagnitude)?h(s.apparentMagnitude,2):"Invisible"),u(s?.angularDiameterLabel),u(Number.isFinite(s?.brightnessRelativeToFullMoon)?h(s.brightnessRelativeToFullMoon,4):"NA"),u(h(s?.apparentSizeRelativeToReference,4)),u(s?.eclipseType)]))),e):(P(e,[y("tr",{},[u("No moons assigned to home world",{colspan:"7",style:"text-align:center;color:var(--muted)"})])]),e)}function ge(e,a=[]){return P(e,(Array.isArray(a)?a:[]).map(t=>y("tr",{},[u(t?.name),u(h(t?.appMag,2)),u(xe(t)),u(t?.note)]))),e}var C=null,fe=new WeakMap;function $e(){return C||(C=import("./apparentSkyNativeThree-BIWPO5SL.js")),C}function Ce(){return typeof window<"u"&&typeof document<"u"}function G(e){return!!e&&Ce()&&e.isConnected!==!1}function ve(e){let a=fe.get(e);return a||(a={generation:0,disposed:!1},fe.set(e,a)),a}function Se(e,a,t,s,i,o,f,S,g={},E=null){if(!G(e))return;let A=ve(e);A.disposed=!1;let O=++A.generation;$e().then(R=>{A.disposed||A.generation!==O||!G(e)||R.drawSkyCanvasNative(e,a,t,s,i,o,f,S,g,typeof E=="function"?(...V)=>{A.disposed||A.generation!==O||!G(e)||E(...V)}:null)}).catch(R=>{console.error("[WorldSmith] Failed to load apparent-sky runtime:",R)})}function Ae(e){if(!e)return;let a=ve(e);a.disposed=!0;let t=++a.generation;C&&C.then(s=>{a.generation===t&&s.disposeSkyCanvasNative(e)}).catch(()=>{})}var p={"Reference body":L({overview:"Planet or moon used as the observer frame for apparent brightness and size.",changes:"Changing this observer changes which bodies are compared, the home-world distances, moon rows, and eclipse context.",feedsInto:"Star apparent table, body apparent table, moon apparent table, and sky preview.",caveat:"The apparent model is a geometry/brightness estimate, not a full sky-rendering ephemeris.",references:"See Science & Maths: apparent magnitude and angular size."}),"Moon phase":`Phase angle applied to all moons uniformly. 0\xB0 = full (opposition), 180\xB0 = new (conjunction, invisible).
...
Pair-host worlds can show two primary suns in a static default sky view or animate them on demand in the sky canvas, while wider hierarchical companions are added using their host-frame separation as an approximate sky-distance reference.`};function Oe(e,a,t,s,i,o,f){let S=t?` <span class="unit">${t}</span>`:"";return`
    <div class="form-row">
      <div>
  ...
  `}function Ne(e){let a=(e?.primarySuns||[]).map(s=>s?.name).filter(Boolean),t=(e?.companionStars||[]).map(s=>s?.name).filter(Boolean);return a.length&&t.length?`Primary suns: ${a.join(", ")}. Companion suns: ${t.join(", ")}.`:a.length>1?`Primary suns: ${a.join(", ")}`:a.length===1?a[0]:t.length?`Companion suns: ${t.join(", ")}`:"single-star sky"}var Ie=[{title:"Getting Started",body:"The Apparent Size page calculates how celestial objects look from your home world \u2014 angular diameter, apparent magnitude, and visibility based on real optics."},{title:"Sky Canvas",body:"The canvas at the top compares angular sizes at true proportions. Tiny objects use logarithmic scaling so they remain visible. Sol reference sizes are shown for comparison."},{title:"Object Tables",body:"Tables list apparent magnitude, angular diameter, phase angle, and illuminated fraction for every planet, giant companion, and moon in your system."},{title:"Phase Functions",body:"Four body types use different scattering models: rocky airless, rocky with atmosphere, gas giant / brown dwarf, and tiny body. Phase angles above 160\xB0 are flagged as too extreme to observe."}];function je(){return K(oe({id:"apparentObjectSelector",title:"Observer selection",summary:"Choose the planet or moon whose sky should be interpreted.",select:{id:"apparentHomePlanet",label:"Reference body",options:[]}}))}function ze(){return K(le({id:"apparentEmptyState",title:"No observer body available",body:"Apparent Size needs a planet or moon observer before it can compare sky brightness, angular size, and visibility.",actions:[{label:"Create a planet",href:"#/planet"}]}))}function sa(e){let a=z(),t=H(a,{mode:F.apparentSelectors}),s=Y(a),i={homePlanetId:s?.id||Object.keys(t.planetsById||{})[0]||"",homeBodyRef:s?.id?{kind:"planet",id:s.id}:Object.keys(t.planetsById||{})[0]?{kind:"planet",id:Object.keys(t.planetsById||{})[0]}:null,moonPhaseDeg:0,distanceByBodyId:{},skyMode:"night",animatePrimaryPair:!1},o=document.createElement("div");o.className="page",o.innerHTML=`
      ...
      <div class="panel__body">
        ...
        <div class="apparent-workbench__grid">
          <section class="apparent-workbench__section" aria-labelledby="apparentInputsTitle">
            ...
            ${Oe("apparentMoonPhase","Moon phase angle","deg",0,180,1,p["Moon phase"])}
          </section>
  ...
  `,e.innerHTML="",e.appendChild(o),ee(o),ae({steps:Ie,storageKey:"worldsmith.apparent.tutorial",container:o,triggerBtn:o.querySelector("#apparentTutorials")});let f=o.querySelector("#apparentHomePlanet"),S=o.querySelector("#apparentMoonPhase"),g=o.querySelector("#apparentSummaryMeta"),E=o.querySelector("#apparentEmptyStateHost"),A=o.querySelector("#apparentKpis"),O=o.querySelector("#apparentStarRows"),R=o.querySelector("#apparentBodyRows"),V=o.querySelector("#apparentMoonRows"),we=o.querySelector("#apparentSolRefRows"),_=o.querySelector("#skyCanvas"),N=o.querySelector("#skyCanvasWrap"),q=o.querySelector("#skyCanvasHint"),T=o.querySelector("#skyPairAnimationToggle"),$=Z({aspectRatio:"5 / 2",label:"Loading sky comparison",className:"apparent-sky-skeleton"});N?.appendChild($);let ke=!0,I=[];function W(){!$||$.hidden||($.hidden=!0,$.setAttribute("aria-busy","false"))}function Pe(c,b){c&&(c.textContent=b==null?"":String(b))}function Me(c,b){let r=Array.isArray(b?.bodiesFromHome)?b.bodiesFromHome.length:0,m=Array.isArray(b?.moons)?b.moons.length:0,M=Number(c?.visibleSunsCount??1+(c?.companionStars?.length||0));Pe(g,`Current snapshot: ${r} body rows, ${m} moon rows, ${M} visible suns.`),E&&(E.hidden=!!c?.homeBodyRef)}let J=new MutationObserver(()=>{if(!o.isConnected){Ae(_);try{J.disconnect()}catch{}}});J.observe(document.body,{childList:!0,subtree:!0});let Re=o.querySelector("#apparentMoonPhase_slider");_e("apparentMoonPhase",S,0,180,1,"auto");function _e(c,b,r,m,M,B){let x=o.querySelector(`#${c}_slider`),j=o.querySelector(`#${c}_min`),n=o.querySelector(`#${c}_max`);j.textContent=String(r),n.textContent=String(m),X({numberEl:b,sliderEl:x,min:r,max:m,step:M,mode:B})}function Q(){let c=H(z(),{mode:F.apparentSelectors});I=te(c);let b=me(f,I,ne(i.homeBodyRef)),r=I.find(M=>String(M?.selectValue||"")===String(b||""));if(r?.observerRef){i.homeBodyRef={...r.observerRef},i.homePlanetId=r.observerRef.kind==="moon"?r.observerRef.parentId||"":r.observerRef.id||"";return}let m=Object.values(c.planetsById||{});i.homePlanetId=ue(f,m,i.homePlanetId),i.homeBodyRef=i.homePlanetId?{kind:"planet",id:i.homePlanetId}:null}function w(){let c=z(),b=H(c,{mode:F.apparentPage}),r=se(b,{homeBodyRef:i.homeBodyRef,homePlanetId:i.homePlanetId,distanceByBodyId:i.distanceByBodyId,moonPhaseDeg:i.moonPhaseDeg});i.homeBodyRef=r.homeBodyRef||i.homeBodyRef,i.homePlanetId=r.homePlanetId||i.homePlanetId;let m=re({starMassMsol:r.starMassMsol,homeOrbitAu:r.homeOrbitAu,orbitSamples:r.orbitSamples,bodySamples:r.bodySamples,moonSamples:r.moonSamples});if(r.hasLivePrimaryPair||(i.animatePrimaryPair=!1),T){let n=!!r.hasLivePrimaryPair;T.hidden=!n,T.setAttribute("aria-pressed",i.animatePrimaryPair?"true":"false"),T.textContent=i.animatePrimaryPair?"Pause primary suns":"Animate primary suns"}m.moons.forEach((n,l)=>{let v=r.moonSamples[l];v&&(v.moonCalc&&(n.moonCalc=v.moonCalc),v.moonProfile&&(n.moonProfile=v.moonProfile),v.visualDescriptor&&(n.visualDescriptor=v.visualDescriptor),v.visualOverrideSignature&&(n.visualOverrideSignature=v.visualOverrideSignature),v.visualRenderSignature&&(n.visualRenderSignature=v.visualRenderSignature))});let M=new Map(r.bodySamples.map(n=>[n.id,n]));m.bodiesFromHome.forEach(n=>{let l=M.get(n.id);l&&(l._derived&&(n._derived=l._derived),l._planetInputs&&(n._planetInputs=l._planetInputs),l._styleId&&(n._styleId=l._styleId),l._visualProfile&&(n._visualProfile=l._visualProfile),l._gasProfile&&(n._gasProfile=l._gasProfile),l._visualDescriptor&&(n._visualDescriptor=l._visualDescriptor),l._visualSubtypeKey&&(n._visualSubtypeKey=l._visualSubtypeKey),l._visualOverrideSignature&&(n._visualOverrideSignature=l._visualOverrideSignature),l._visualRenderSignature&&(n._visualRenderSignature=l._visualRenderSignature),l.renderFamily&&(n.renderFamily=l.renderFamily),l.classLabel&&(n.classLabel=l.classLabel))});let B=[...m.bodiesFromHome].filter(n=>Number.isFinite(n.apparentMagnitude)).sort((n,l)=>n.apparentMagnitude-l.apparentMagnitude)[0],x=[...m.moons].filter(n=>Number.isFinite(n.apparentMagnitude)).sort((n,l)=>n.apparentMagnitude-l.apparentMagnitude)[0];if(Me(r,m),ce(A,[{label:"Star absolute magnitude",value:h(m.star.absoluteMagnitude,3),meta:"M"},{label:"Home orbit",value:h(r.homeOrbitAu,3),meta:"AU"},{label:"Home star magnitude",value:h(m.starByOrbit[0]?.magnitude,3),meta:"at home"},{label:"Brightest object",value:B?B.name:"-",meta:B?`${h(B.apparentMagnitude,2)} mag`:"-"},{label:"Brightest moon",value:x?x.name:"-",meta:x?`${h(x.apparentMagnitude,2)} mag`:m.moons.length?"All invisible at this phase":"No moons"},{label:"Moon count",value:String(m.moons.length),meta:r.isMoonObserver?"shown as nearby bodies":"assigned to reference body"},{label:"Visible suns",value:String(r.visibleSunsCount??1+(r.companionStars?.length||0)),meta:Ne(r)}],p),he(O,m.starByOrbit),m.bodiesFromHome.forEach(n=>{i.distanceByBodyId[n.id]=n.currentDistanceAu}),be(R,m.bodiesFromHome),ye(V,m.moons),ge(we,ie),q){let n="";r.hasLivePrimaryPair&&i.animatePrimaryPair&&r.hasApproximateCompanionSuns?n="Live pair phase: primary suns follow the local binary orbit on a compressed simulation timescale, while companion suns use host-frame separation as an approximate sky-distance reference.":r.hasLivePrimaryPair&&i.animatePrimaryPair?n="Live pair phase: the two primary suns follow the local binary orbit on a compressed simulation timescale.":r.hasLivePrimaryPair&&r.hasApproximateCompanionSuns?n="Static pair view by default. Use Animate primary suns to play the local binary orbit on a compressed simulation timescale; companion suns use host-frame separation as an approximate sky-distance reference.":r.hasLivePrimaryPair?n="Static pair view by default. Use Animate primary suns to play the local binary orbit on a compressed simulation timescale.":r.hasApproximatePrimarySuns?n="Schematic sky layout: local multi-primary host suns are grouped for readability and are not phase-resolved.":r.hasApproximateCompanionSuns&&(n=r.primarySuns?.length>1?"Schematic sky layout: primary suns are drawn together, while companion suns use host-frame separation as an approximate sky-distance reference.":"Schematic sky layout: companion suns use host-frame separation as an approximate sky-distance reference."),q.textContent=n,q.hidden=!n}let j=r.starModel;if(r.homeBodyRef){if(ke){let n={dayHex:r.homeSkyDayHex,dayEdgeHex:r.homeSkyDayEdgeHex,horizonHex:r.homeSkyHorizonHex};Se(_,m,j?.starColourHex,i.skyMode,i.moonPhaseDeg,n,{starTempK:j?.tempK,starMassMsol:r.starMassMsol,starAgeGyr:r.starAgeGyr},r.skyStars||r.companionStars||[],{animatePrimaryPair:i.animatePrimaryPair},W)}}else{W();let n=N?.getBoundingClientRect?.();if(n&&_){let l=window.devicePixelRatio||1,v=Math.round(n.width*l),U=Math.round(n.height*l);_.width=v,_.height=U;let k=_.getContext("2d");k&&(k.fillStyle="#050818",k.fillRect(0,0,v,U),k.font=`italic ${12*l}px system-ui, sans-serif`,k.fillStyle="rgba(160,170,200,0.5)",k.textAlign="center",k.textBaseline="middle",k.fillText("Add planets to populate the sky comparison",v/2,U/2))}}}f?.addEventListener("change",()=>{let c=I.find(b=>String(b?.selectValue||"")===String(f.value||""));i.homeBodyRef=c?.observerRef?{...c.observerRef}:null,i.homePlanetId=i.homeBodyRef?.kind==="moon"?i.homeBodyRef.parentId||"":i.homeBodyRef?.id||"",Q(),w()}),R?.addEventListener("change",c=>{let b=c.target?.closest?.("input[data-distance-id]");if(!b)return;let r=String(b.dataset.distanceId||""),m=Number(b.value);!r||!Number.isFinite(m)||(i.distanceByBodyId[r]=m,w())}),Re?.addEventListener("input",()=>{i.moonPhaseDeg=Number(S.value)||0,w()}),S?.addEventListener("change",()=>{i.moonPhaseDeg=Number(S.value)||0,w()}),o.addEventListener("change",c=>{c.target.name==="skyBg"&&(i.skyMode=c.target.value,w())}),T?.addEventListener("click",()=>{i.animatePrimaryPair=!i.animatePrimaryPair,w()}),N&&new ResizeObserver(()=>w()).observe(N),Q(),S.value=String(i.moonPhaseDeg),S.dispatchEvent(new Event("input",{bubbles:!0})),w()}export{sa as initApparentPage};
