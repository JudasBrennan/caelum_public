...
This is only shown for frozen-surface cases and is intended as a first-pass structural estimate.`,"High-pressure Ice Barrier":`Flags when the modeled ocean is deep enough that high-pressure ice is likely to form beneath it.

If present, the ocean may be partially separated from deeper rocky material by dense ice phases.`,"High-Pressure Ice":`Flags when the modeled ocean is deep enough that high-pressure ice is likely to form beneath it.

If present, the ocean may be partially separated from deeper rocky material by dense ice phases.`,"Interior Structure":"Compact readout of the current solved moon interior: ocean depth plus the inferred ice-shell convection regime.","Ocean Chemistry":"Surface or subsurface ocean chemistry inputs used in Full and Manual hydrosphere modes.","Radiogenic Heating":`Internal heat from radioactive decay (U, Th, K) on the moon\u2019s surface.
