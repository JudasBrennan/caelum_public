import{a as t,b as e,c as l,d as r,e as a,f as i,g as n,h as o}from"./chunk-L3XYPVN7.js";import"./chunk-VC46IEJQ.js";function c(s){return[i("Stellar Neighbourhoods",`<p>If you could look at the stars near our Sun -- say, within about
      ...
      ${n("Imagine a town where most residents are quiet, unassuming folk who stay indoors (red dwarfs). A few are loud and visible from a distance (bright stars). And there are some retired residents (white dwarfs) and a surprising number of teenagers who never quite grew up (brown dwarfs).")}
      ${o("The solar neighbourhood is dominated by faint red dwarfs (~76% of all stars). Bright Sun-like stars are a small minority.")}`,`<p>Volume-limited surveys of the solar neighbourhood (typically
        within 10 pc) provide the most unbiased census of stellar
        populations. The Reyl\xE9 et al. (2021) 10 pc sample gives:</p>
      ${a(["Category","Fraction","Count (within 10 pc)"],[["Main-sequence stars","72%","~290"],["White dwarfs","6%","~25"],["Brown dwarfs (T and Y)","19%","~78"],["Sub-brown dwarfs / planetary-mass","3%","~12"]])}
      <p>Among main-sequence stars, the spectral-class breakdown is heavily
        bottom-weighted:</p>
      ${a(["Spectral class","Fraction of MS stars","Notes"],[["M (red dwarf)","~76%","Dominant population by number"],["K (orange dwarf)","~13%","Longer-lived than G stars"],["G (Sun-like)","~6%","Includes the Sun"],["F","~3%","Brighter, shorter-lived"],["A, B, O","< 2%","Rare, luminous, short-lived"]])}
      <p>The mass function ${e("\\xi(M)")} (initial mass function, IMF)
        is well described by Kroupa (2001):</p>
      ${t("\\xi(M) \\propto M^{-\\alpha}, \\quad \\alpha = \\begin{cases} 0.3 & M < 0.08 \\\\ 1.3 & 0.08 \\leq M < 0.5 \\\\ 2.3 & M \\geq 0.5 \\end{cases}")}
      <p>The steep slope above 0.5 ${e("M_\\odot")} explains the rarity
        of massive stars.</p>
      ${r("Reyl\xE9 et al. (2021, A&A 650, A201); Kroupa (2001, MNRAS 322, 231)")}`,s),i("Binary and Multiple Stars",`<p>Many stars do not travel alone. A large fraction come in pairs
      ...
      <p>The fraction of stars with companions varies by type: massive,
        ...
        more often single.</p>
      ${n("Stars are like people at a dance. The brightest, most energetic dancers almost always pair up. The quieter ones (red dwarfs) are more likely to be found dancing alone.")}
      ${o("Many stars are binaries or multiples. Massive stars are almost always paired, while red dwarfs are mostly single.")}`,`<p>The <strong>multiplicity fraction</strong> (MF) -- the fraction
        of primary stars with at least one companion -- varies strongly
        with spectral type. The Duch\xEAne & Kraus (2013) compilation
        gives:</p>
      ${a(["Spectral type","Multiplicity fraction","Median period"],[["O","~70%","~10 d"],["B","~50%","~100 d"],["A","~48%","~300 d"],["FGK","~46%","~10\\(^{4.5}\\) d (~80 yr)"],["M","~27%","~10\\(^{5}\\) d (~300 yr)"],["Brown dwarfs","~15%","~10\\(^{1.5}\\) d (~30 d)"]])}
      <p>The period distribution is approximately log-normal, with the
        ...
        mass-ratio distribution ${e("q = M_2 / M_1")} is roughly flat
        for solar-type stars but shows a preference for near-equal masses
        (${e("q \\to 1")}) among M dwarfs.</p>
      ...
      ${t("a_{\\text{stable}} \\gtrsim 3\\text{--}5 \\times a_{\\text{binary}} \\quad (\\text{P-type})")}
      ${t("a_{\\text{stable}} \\lesssim 0.2\\text{--}0.3 \\times a_{\\text{binary}} \\quad (\\text{S-type})")}
      ${r("Duch\xEAne & Kraus (2013, ARA&A 51, 269); Holman & Wiegert (1999, AJ 117, 621)")}`,s),i("Metallicity Distribution",`<p>In astronomy, any element heavier than helium is called a
      ...
      ${o("Metallicity measures a star's heavy-element content relative to the Sun. Higher metallicity means more raw material for building planets.")}`,`<p>Metallicity is conventionally expressed as ${e("[\\text{Fe/H}]")}
      ...
      <p>The solar neighbourhood metallicity distribution is approximately
        Gaussian:</p>
      ${a(["Parameter","Value","Source"],[["Mean [Fe/H]","-0.05 dex","Nordstr\xF6m et al. (2004)"],["Dispersion \\(\\sigma\\)","\\(\\pm\\)0.20 dex","Thin disk population"],["Radial gradient","-0.06 dex/kpc","Galactocentric radius"],["Vertical gradient","-0.30 dex/kpc","Distance from Galactic plane"]])}
      ...
      <p>Planet formation correlates with metallicity: the probability of
        ...
        ${e("P \\propto 10^{2[\\text{Fe/H}]}")} (Fischer & Valenti 2005),
        with a baseline near 7% at solar metallicity, while rocky planet
        occurrence is less metallicity-dependent.</p>
      ${r("Nordstr\xF6m et al. (2004, A&A 418, 989); Fischer & Valenti (2005, ApJ 622, 1102); Johnson et al. (2010, PASP 122, 905)")}`,s),i("The Galactic Habitable Zone",`<p>Just as there is a habitable zone around a star (where liquid
      ...
      ${n("The galaxy is like a city. The dense downtown (galactic centre) is too noisy and hazardous. The far suburbs (outer galaxy) lack the resources. The best neighbourhoods are the quiet middle rings -- close enough to have good infrastructure, far enough to be safe.")}
      ${o("The galactic habitable zone is a ring where metallicity is high enough for rocky planets but supernova rates are low enough for life to survive long term.")}`,`<p>The concept of a Galactic Habitable Zone (GHZ) was formalised by
      ...
      <ul>
        <li><strong>Sufficient metallicity</strong> for terrestrial planet
            formation: ${e("[\\text{Fe/H}] \\gtrsim -0.5")} is typically
      ...
      <p>Lineweaver et al. (2004) estimated the GHZ probability as a
        function of Galactocentric radius ${e("R_{\\text{GC}}")} and
        time:</p>
      ${t("P_{\\text{GHZ}}(R,\\,t) \\propto P_{\\text{metal}}(R,\\,t) \\times P_{\\text{SN}}(R,\\,t) \\times \\Theta(t - t_{\\text{evol}})")}
      ${l([["P_{\\text{metal}}","probability of sufficient metallicity for planet formation"],["P_{\\text{SN}}","probability of avoiding sterilising supernovae"],["\\Theta","Heaviside step function; zero before minimum evolution time"],["t_{\\text{evol}}","minimum time for complex life (~4 Gyr)"]])}
      ...
      ${a(["Radius (kpc)","Metallicity","SN rate","GHZ probability"],[["3--5","High","High","Low (too hazardous)"],["7--9","Solar-like","Moderate","Highest"],["10--12","Sub-solar","Low","Moderate"],["> 15","Low","Very low","Low (insufficient metals)"]])}
      ${r("Gonzalez, Brownlee & Ward (2001, Icarus 152, 185); Lineweaver, Fenner & Gibson (2004, Science 303, 59)")}`,s)].join("")}export{c as buildLesson19};
