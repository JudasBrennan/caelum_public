...
export function buildMoonSolveArgsForWorld(
  ...
  const args = {
    ...
    hostPrebioticUvEarthAt1Au: planetBundle.solveContext?.hostPrebioticUvEarthAt1Au ?? null,
    hostWindPressureEarthAt1Au: planetBundle.solveContext?.hostWindPressureEarthAt1Au ?? null,
    ...
    companionPrebioticUvEarth: planetBundle.solveContext?.companionPrebioticUvEarth ?? 0,
    companionWindPressureEarth: planetBundle.solveContext?.companionWindPressureEarth ?? 0,
